...
namespace CG
{
	 ...
	 */
	class UR_Weapon_B9A05_Set00_LODP_Skeleton_AnimBlueprint_C : public UWeaponAnimInstance
	{
	public:
		struct FAnimNode_Root                                      AnimGraphNode_Root;                                      // 0x02D0(0x0030) NativeAccessSpecifierPublic
		struct FAnimNode_Slot                                      AnimGraphNode_Slot;                                      // 0x0300(0x0048) NativeAccessSpecifierPublic
		struct FAnimNode_RefPose                                   AnimGraphNode_LocalRefPose;                              // 0x0348(0x0018) NativeAccessSpecifierPublic

	public:
		void ExecuteUbergraph_R_Weapon_B9A05_Set00_LODP_Skeleton_AnimBlueprint(int32_t bpp__EntryPoint__pf);
