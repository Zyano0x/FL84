...
namespace CG
{
	...
	void UUI_Lobby_Battery_C::ForceRefreshBatteryUI()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_Battery.UI_Lobby_Battery_C.ForceRefreshBatteryUI"));
	...
	void UUI_Lobby_Battery_C::RefreshBatteryUI(int32_t BatteryLevelNewParam, bool bCharging)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_Battery.UI_Lobby_Battery_C.RefreshBatteryUI"));
	...
	void UUI_Lobby_Battery_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_Battery.UI_Lobby_Battery_C.PreConstruct"));
	...
	void UUI_Lobby_Battery_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_Battery.UI_Lobby_Battery_C.Construct"));
	...
	void UUI_Lobby_Battery_C::EventRefreshBatteryUI()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_Battery.UI_Lobby_Battery_C.EventRefreshBatteryUI"));
	...
	void UUI_Lobby_Battery_C::Destruct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_Battery.UI_Lobby_Battery_C.Destruct"));
	...
	void UUI_Lobby_Battery_C::ExecuteUbergraph_UI_Lobby_Battery(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_Battery.UI_Lobby_Battery_C.ExecuteUbergraph_UI_Lobby_Battery"));
	...
	UClass* UUI_Lobby_Battery_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("WidgetBlueprintGeneratedClass UI_Lobby_Battery.UI_Lobby_Battery_C"));
		return ptr;
	}
