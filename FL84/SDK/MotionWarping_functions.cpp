...
void UMotionWarpingComponent::AddOrUpdateWarpTarget(class FName WarpTargetName, struct FMotionWarpingTarget& WarpTarget)
{
	static class UFunction* Func = nullptr;
...
void URootMotionModifier_AdjustmentBlendWarp::GetAdjustmentBlendIKBoneTransformAndAlpha(class ACharacter* Character, class FName BoneName, struct FTransform* OutTransform, float* OutAlpha)
{
	...
	if (!Func)
		Func = Class->GetFunction("RootMotionModifier_AdjustmentBlendWarp", "GetAdjustmentBlendIKBoneTransformAndAlpha");

	Params::URootMotionModifier_AdjustmentBlendWarp_GetAdjustmentBlendIKBoneTransformAndAlpha_Params Parms{};
...
class URootMotionModifier_AdjustmentBlendWarp* URootMotionModifier_AdjustmentBlendWarp::AddRootMotionModifierAdjustmentBlendWarp(class UMotionWarpingComponent* InMotionWarpingComp, class UAnimSequenceBase* InAnimation, float InStartTime, float InEndTime, class FName InWarpTargetName, enum class EWarpPointAnimProvider InWarpPointAnimProvider, const struct FTransform& InWarpPointAnimTransform, class FName InWarpPointAnimBoneName, bool bInWarpTranslation, bool bInIgnoreZAxis, bool bInWarpRotation, bool bInWarpIKBones, TArray<class FName>& InIKBones)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("RootMotionModifier_AdjustmentBlendWarp", "AddRootMotionModifierAdjustmentBlendWarp");

	Params::URootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp_Params Parms{};
