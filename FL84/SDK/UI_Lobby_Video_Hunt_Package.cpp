...
namespace CG
{
	...
	class FString UUI_Lobby_Video_Hunt_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Video_Hunt.UI_Lobby_Video_Hunt_C.GetModuleName");
	...
	UClass* UUI_Lobby_Video_Hunt_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Lobby_Video_Hunt.UI_Lobby_Video_Hunt_C");
		return ptr;
	}
