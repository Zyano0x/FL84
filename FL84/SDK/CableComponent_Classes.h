...
namespace CG
{
	 ...
	 * Size -> 0x0098 (FullSize[0x0610] - InheritedSize[0x0578])
	 */
	class UCableComponent : public UMeshComponent
	{
	public:
		unsigned char                                              UnknownData_RQGF[0x8];                                   // 0x0578(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_SSQP[0x2];                                   // 0x05CE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3297[0x20];                                  // 0x05F0(0x0020) MISSED OFFSET (PADDING)
