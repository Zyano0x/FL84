...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_7O29[0x8];                                   // 0x0578(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_R8ZZ[0x2];                                   // 0x05CE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZJ86[0x20];                                  // 0x05F0(0x0020) MISSED OFFSET (PADDING)
