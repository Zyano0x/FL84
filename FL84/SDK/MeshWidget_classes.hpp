...
public:
	...
	uint8                                        Pad_C88[0x34];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C92[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	class UMaterialInterface*                    BaseMaterial;                                      // 0x148(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_C94[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	class UMaterialInterface*                    BaseMaterial;                                      // 0x148(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_C98[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
