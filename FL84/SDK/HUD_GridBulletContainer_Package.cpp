...
namespace CG
{
	...
	void UHUD_GridBulletContainer_C::ReceiveUpdateMaxAmmoEvent(int32_t InMaxAmmo)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HUD_GridBulletContainer.HUD_GridBulletContainer_C.ReceiveUpdateMaxAmmoEvent");
	...
	void UHUD_GridBulletContainer_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HUD_GridBulletContainer.HUD_GridBulletContainer_C.Construct");
	...
	void UHUD_GridBulletContainer_C::ExecuteUbergraph_HUD_GridBulletContainer(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function HUD_GridBulletContainer.HUD_GridBulletContainer_C.ExecuteUbergraph_HUD_GridBulletContainer");
	...
	UClass* UHUD_GridBulletContainer_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass HUD_GridBulletContainer.HUD_GridBulletContainer_C");
		return ptr;
	}
