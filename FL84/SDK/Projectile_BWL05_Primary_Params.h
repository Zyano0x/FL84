...
namespace CG
{
	 ...
	 */
	struct AProjectile_BWL05_Primary_C_BndEvt__MovementComp_K2Node_ComponentBoundEvent_0_OnProjectileStopDelegate__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct AProjectile_BWL05_Primary_C_ExecuteUbergraph_Projectile_BWL05_Primary_Params
	{
	public:
