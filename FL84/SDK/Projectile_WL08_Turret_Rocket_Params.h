...
namespace CG
{
	 ...
	 */
	struct AProjectile_WL08_Turret_Rocket_C_BndEvt__MovementComp_K2Node_ComponentBoundEvent_0_OnProjectileStopDelegate__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct AProjectile_WL08_Turret_Rocket_C_ExecuteUbergraph_Projectile_WL08_Turret_Rocket_Params
	{
	public:
