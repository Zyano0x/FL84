...
namespace CG
{
	...
	class FString UUI_Currency_Bar_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Currency_Bar.UI_Currency_Bar_C.GetModuleName");
	...
	UClass* UUI_Currency_Bar_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Currency_Bar.UI_Currency_Bar_C");
		return ptr;
	}
