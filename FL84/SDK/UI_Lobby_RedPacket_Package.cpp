...
namespace CG
{
	...
	class FString UUI_Lobby_RedPacket_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_RedPacket.UI_Lobby_RedPacket_C.GetModuleName");
	...
	UClass* UUI_Lobby_RedPacket_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Lobby_RedPacket.UI_Lobby_RedPacket_C");
		return ptr;
	}
