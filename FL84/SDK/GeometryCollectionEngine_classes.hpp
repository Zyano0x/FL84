...
public:
	...
	uint8                                        Pad_D94[0x108];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DB0[0xE0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DC0[0x1FE];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DDF[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DE8[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DEF[0x14];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DF2[0x7E];                                     // Fixing Size Of Struct [ Dumper-7 ]
