...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_5K5V[0x3];                                   // 0x0699(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NHYN[0x3];                                   // 0x06AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_M92U[0xB];                                   // 0x06B5(0x000B) MISSED OFFSET (PADDING)
