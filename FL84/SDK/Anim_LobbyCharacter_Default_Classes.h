...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0M41[0x3];                                   // 0x0699(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_98XD[0x3];                                   // 0x06AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_L59G[0xB];                                   // 0x06B5(0x000B) MISSED OFFSET (PADDING)
