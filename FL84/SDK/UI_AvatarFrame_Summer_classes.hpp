...
public:
	...
	static class UUI_AvatarFrame_Summer_C* GetDefaultObj();
	...
	void Construct();
	void Update();
	void ExecuteUbergraph_UI_AvatarFrame_Summer(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool K2Node_Event_IsDesignTime);
