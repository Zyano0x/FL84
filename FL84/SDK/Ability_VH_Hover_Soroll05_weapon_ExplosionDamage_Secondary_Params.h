...
namespace CG
{
	 ...
	 */
	struct AAbility_VH_Hover_Soroll05_weapon_ExplosionDamage_Secondary_C_ReceiveBeginPlay_Params
	{	};
	 ...
	 */
	struct AAbility_VH_Hover_Soroll05_weapon_ExplosionDamage_Secondary_C_ReceiveTick_Params
	{
	public:
	 ...
	 */
	struct AAbility_VH_Hover_Soroll05_weapon_ExplosionDamage_Secondary_C_ExecuteUbergraph_Ability_VH_Hover_Soroll05_weapon_ExplosionDamage_Secondary_Params
	{
	public:
