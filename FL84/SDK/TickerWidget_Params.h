...
namespace CG
{
	...
	/**
	 * Function TickerWidget.TickerWidget_C.CustomEvent_1
	 */
	struct UTickerWidget_C_CustomEvent_1_Params
	{
	public:
	...
	public:
		...
		unsigned char                                              UnknownData_KXTQ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
