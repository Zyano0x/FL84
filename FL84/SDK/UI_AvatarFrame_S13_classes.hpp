...
class UUI_AvatarFrame_S13_C : public USolarUserWidget
{
public:
	...
	static class UUI_AvatarFrame_S13_C* GetDefaultObj();
	...
	void Construct();
	void Update();
	void ExecuteUbergraph_UI_AvatarFrame_S13(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool K2Node_Event_IsDesignTime);
