...
namespace CG
{
	 ...
	 */
	class UUI_HUD_Notice_CutIn_Crash_C : public UUserWidget
	{
	public:
		...
		class UWidgetAnimation*                                    Loop_Nova_Anim;                                          // 0x0270(0x0008) BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash
