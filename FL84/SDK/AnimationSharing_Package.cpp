...
namespace CG
{
	...
	void UAnimSharingStateInstance::GetInstancedActors(TArray<class AActor*>* Actors)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimationSharing.AnimSharingStateInstance.GetInstancedActors"));
	...
	UClass* UAnimSharingStateInstance::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class AnimationSharing.AnimSharingStateInstance"));
		return ptr;
	}
	...
	UClass* UAnimSharingTransitionInstance::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class AnimationSharing.AnimSharingTransitionInstance"));
		return ptr;
	}
	...
	UClass* UAnimSharingAdditiveInstance::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class AnimationSharing.AnimSharingAdditiveInstance"));
		return ptr;
	}
	...
	UClass* UAnimSharingInstance::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class AnimationSharing.AnimSharingInstance"));
		return ptr;
	}
	...
	void UAnimationSharingManager::RegisterActorWithSkeletonBP(class AActor* InActor, class USkeleton* SharingSkeleton)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimationSharing.AnimationSharingManager.RegisterActorWithSkeletonBP"));
	...
	class UAnimationSharingManager* UAnimationSharingManager::STATIC_GetAnimationSharingManager(class UObject* WorldContextObject)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimationSharing.AnimationSharingManager.GetAnimationSharingManager"));
	...
	bool UAnimationSharingManager::STATIC_CreateAnimationSharingManager(class UObject* WorldContextObject, class UAnimationSharingSetup* Setup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimationSharing.AnimationSharingManager.CreateAnimationSharingManager"));
	...
	bool UAnimationSharingManager::STATIC_AnimationSharingEnabled()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimationSharing.AnimationSharingManager.AnimationSharingEnabled"));
	...
	UClass* UAnimationSharingManager::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class AnimationSharing.AnimationSharingManager"));
		return ptr;
	}
	...
	UClass* UAnimationSharingSetup::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class AnimationSharing.AnimationSharingSetup"));
		return ptr;
	}
	...
	void UAnimationSharingStateProcessor::ProcessActorState(int32_t* OutState, class AActor* InActor, unsigned char CurrentState, unsigned char OnDemandState, bool* bShouldProcess)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimationSharing.AnimationSharingStateProcessor.ProcessActorState"));
	...
	class UEnum* UAnimationSharingStateProcessor::GetAnimationStateEnum()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimationSharing.AnimationSharingStateProcessor.GetAnimationStateEnum"));
	...
	UClass* UAnimationSharingStateProcessor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class AnimationSharing.AnimationSharingStateProcessor"));
		return ptr;
	}
