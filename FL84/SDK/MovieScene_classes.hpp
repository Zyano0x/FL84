...
public:
	...
	uint8                                        Pad_5B8[0x15];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5BF[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5C7[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6A7[0x3E0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6AB[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6AD[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6AE[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_6C0[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
