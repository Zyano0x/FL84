...
namespace CG
{
	...
	void UUI_Component_Switch_C::SetType(bool IsCircleType)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Switch.UI_Component_Switch_C.SetType");
	...
	void UUI_Component_Switch_C::InitValue(bool InValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Switch.UI_Component_Switch_C.InitValue");
	...
	void UUI_Component_Switch_C::SetValue(bool InValue, bool CallChangeEvent, bool PlayAnimation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Switch.UI_Component_Switch_C.SetValue");
	...
	void UUI_Component_Switch_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Switch.UI_Component_Switch_C.PreConstruct");
	...
	void UUI_Component_Switch_C::BndEvt__TouchArea_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Switch.UI_Component_Switch_C.BndEvt__TouchArea_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
	...
	void UUI_Component_Switch_C::ExecuteUbergraph_UI_Component_Switch(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Switch.UI_Component_Switch_C.ExecuteUbergraph_UI_Component_Switch");
	...
	void UUI_Component_Switch_C::OnSwitchClicked__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Switch.UI_Component_Switch_C.OnSwitchClicked__DelegateSignature");
	...
	void UUI_Component_Switch_C::OnStateChanged__DelegateSignature(bool NewValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Switch.UI_Component_Switch_C.OnStateChanged__DelegateSignature");
	...
	UClass* UUI_Component_Switch_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Component_Switch.UI_Component_Switch_C");
		return ptr;
	}
