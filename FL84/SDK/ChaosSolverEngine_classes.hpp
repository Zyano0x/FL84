...
{
public:
	uint8                                        Pad_1CE6[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1CEA[0x110];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1CF2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1CF6[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
