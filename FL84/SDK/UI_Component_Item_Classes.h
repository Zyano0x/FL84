...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_YDZL[0x3];                                   // 0x04F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YF3K[0x1];                                   // 0x0507(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
