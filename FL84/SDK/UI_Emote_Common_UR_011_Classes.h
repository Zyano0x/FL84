...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_Emote_Common_UR_011.UI_Emote_Common_UR_011_C
	 * Size -> 0x0030 (FullSize[0x0678] - InheritedSize[0x0648])
	 */
	class UUI_Emote_Common_UR_011_C : public UEmojiBubbleWidget
	{
	public:
	...
	public:
		...
		void Construct();
		void ExecuteUbergraph_UI_Emote_Common_UR_011(int32_t EntryPoint);
