...
public:
	...
	static class AProjectile_BMphy08_Primary_C* GetDefaultObj();
	...
	void ExecuteUbergraph_Projectile_BMphy08_Primary(int32 EntryPoint, const struct FHitResult& K2Node_ComponentBoundEvent_ImpactResult);
};
