...
namespace CG
{
	...
	class FString UUI_Root_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Root.UI_Root_C.GetModuleName");
	...
	void UUI_Root_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Root.UI_Root_C.PreConstruct");
	...
	void UUI_Root_C::CustomEvent_1(class UObject* Publisher, class UObject* Payload, TArray<class FString> MetaData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Root.UI_Root_C.CustomEvent_1");
	...
	void UUI_Root_C::ExecuteUbergraph_UI_Root(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Root.UI_Root_C.ExecuteUbergraph_UI_Root");
	...
	UClass* UUI_Root_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Root.UI_Root_C");
		return ptr;
	}
