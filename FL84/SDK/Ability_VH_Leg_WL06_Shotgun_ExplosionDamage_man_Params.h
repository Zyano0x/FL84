...
namespace CG
{
	 ...
	 */
	struct AAbility_VH_Leg_WL06_Shotgun_ExplosionDamage_man_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function Ability_VH_Leg_WL06_Shotgun_ExplosionDamage_man.Ability_VH_Leg_WL06_Shotgun_ExplosionDamage_man_C.ReceiveTick
	 */
	struct AAbility_VH_Leg_WL06_Shotgun_ExplosionDamage_man_C_ReceiveTick_Params
	{
	public:
	 ...
	 */
	struct AAbility_VH_Leg_WL06_Shotgun_ExplosionDamage_man_C_ExecuteUbergraph_Ability_VH_Leg_WL06_Shotgun_ExplosionDamage_man_Params
	{
	public:
