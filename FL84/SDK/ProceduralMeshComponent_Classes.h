...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_IJT5[0x8];                                   // 0x0578(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_YZFI[0x6];                                   // 0x0582(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CIER[0x4];                                   // 0x05CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
