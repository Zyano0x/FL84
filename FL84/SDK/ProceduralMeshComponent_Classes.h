...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_RPWF[0x8];                                   // 0x0578(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_NKX3[0x6];                                   // 0x0582(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DUHE[0x4];                                   // 0x05CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
