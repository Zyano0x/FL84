...
namespace CG
{
	...
	class UCineCameraComponent* ACineCameraActor::GetCineCameraComponent()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CineCameraActor.GetCineCameraComponent"));
	...
	UClass* ACineCameraActor::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CinematicCamera.CineCameraActor"));
		return ptr;
	}
	...
	UClass* ACameraRig_Crane::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CinematicCamera.CameraRig_Crane"));
		return ptr;
	}
	...
	class USplineComponent* ACameraRig_Rail::GetRailSplineComponent()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CameraRig_Rail.GetRailSplineComponent"));
	...
	UClass* ACameraRig_Rail::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CinematicCamera.CameraRig_Rail"));
		return ptr;
	}
	...
	void UCineCameraComponent::SetLensPresetByName(const class FString& InPresetName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CineCameraComponent.SetLensPresetByName"));
	...
	void UCineCameraComponent::SetFilmbackPresetByName(const class FString& InPresetName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CineCameraComponent.SetFilmbackPresetByName"));
	...
	void UCineCameraComponent::SetCurrentFocalLength(float InFocalLength)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CineCameraComponent.SetCurrentFocalLength"));
	...
	float UCineCameraComponent::GetVerticalFieldOfView()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CineCameraComponent.GetVerticalFieldOfView"));
	...
	TArray<struct FNamedLensPreset> UCineCameraComponent::STATIC_GetLensPresetsCopy()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CineCameraComponent.GetLensPresetsCopy"));
	...
	class FString UCineCameraComponent::GetLensPresetName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CineCameraComponent.GetLensPresetName"));
	...
	float UCineCameraComponent::GetHorizontalFieldOfView()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CineCameraComponent.GetHorizontalFieldOfView"));
	...
	class FString UCineCameraComponent::GetFilmbackPresetName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CineCameraComponent.GetFilmbackPresetName"));
	...
	class FString UCineCameraComponent::GetDefaultFilmbackPresetName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CinematicCamera.CineCameraComponent.GetDefaultFilmbackPresetName"));
	...
	UClass* UCineCameraComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CinematicCamera.CineCameraComponent"));
		return ptr;
	}
