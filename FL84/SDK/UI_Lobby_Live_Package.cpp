...
namespace CG
{
	...
	void UUI_Lobby_Live_C::PreConstruct(bool IsDesignTime)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Live.UI_Lobby_Live_C.PreConstruct");
	...
	void UUI_Lobby_Live_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Live.UI_Lobby_Live_C.Construct");
	...
	void UUI_Lobby_Live_C::ExecuteUbergraph_UI_Lobby_Live(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Live.UI_Lobby_Live_C.ExecuteUbergraph_UI_Lobby_Live");
	...
	UClass* UUI_Lobby_Live_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Lobby_Live.UI_Lobby_Live_C");
		return ptr;
	}
