...
namespace CG
{
	...
	void UCrosshair_Simple_Sniper_C::InitializeCrosshairSpread(float Spread)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function Crosshair_Simple_Sniper.Crosshair_Simple_Sniper_C.InitializeCrosshairSpread"));
	...
	void UCrosshair_Simple_Sniper_C::SetCrosshairSprite(class UPaperSprite* InSprite)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function Crosshair_Simple_Sniper.Crosshair_Simple_Sniper_C.SetCrosshairSprite"));
	...
	void UCrosshair_Simple_Sniper_C::ExecuteUbergraph_Crosshair_Simple_Sniper(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function Crosshair_Simple_Sniper.Crosshair_Simple_Sniper_C.ExecuteUbergraph_Crosshair_Simple_Sniper"));
	...
	UClass* UCrosshair_Simple_Sniper_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("WidgetBlueprintGeneratedClass Crosshair_Simple_Sniper.Crosshair_Simple_Sniper_C"));
		return ptr;
	}
