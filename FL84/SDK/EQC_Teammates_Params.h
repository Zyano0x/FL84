...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function EQC_Teammates.EQC_Teammates_C.ProvideSingleLocation
	 */
	struct UEQC_Teammates_C_ProvideSingleLocation_Params
	{
	public:
		...
		unsigned char                                              UnknownData_FC2W[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
