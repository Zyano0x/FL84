...
namespace CG
{
	...
	void UUI_Component_Platform_C::SetBlendPlatform(bool UseIcon)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Platform.UI_Component_Platform_C.SetBlendPlatform");
	...
	void UUI_Component_Platform_C::SetSizeState(E_Platform Platform)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Platform.UI_Component_Platform_C.SetSizeState");
	...
	void UUI_Component_Platform_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Platform.UI_Component_Platform_C.PreConstruct");
	...
	void UUI_Component_Platform_C::ExecuteUbergraph_UI_Component_Platform(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Platform.UI_Component_Platform_C.ExecuteUbergraph_UI_Component_Platform");
	...
	UClass* UUI_Component_Platform_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Component_Platform.UI_Component_Platform_C");
		return ptr;
	}
