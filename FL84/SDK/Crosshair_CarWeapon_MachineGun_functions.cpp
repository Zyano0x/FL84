...
class UClass* UCrosshair_CarWeapon_MachineGun_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Crosshair_CarWeapon_MachineGun_C");

	return Clss;
}


// Crosshair_CarWeapon_MachineGun_C Crosshair_CarWeapon_MachineGun.Default__Crosshair_CarWeapon_MachineGun_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCrosshair_CarWeapon_MachineGun_C* UCrosshair_CarWeapon_MachineGun_C::GetDefaultObj()
{
	static class UCrosshair_CarWeapon_MachineGun_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCrosshair_CarWeapon_MachineGun_C*>(UCrosshair_CarWeapon_MachineGun_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Crosshair_CarWeapon_MachineGun.Crosshair_CarWeapon_MachineGun_C.GetReloadWidget
...
class UUserWidget* UCrosshair_CarWeapon_MachineGun_C::GetReloadWidget()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Crosshair_CarWeapon_MachineGun_C", "GetReloadWidget");

	Params::UCrosshair_CarWeapon_MachineGun_C_GetReloadWidget_Params Parms{};
...
// Function Crosshair_CarWeapon_MachineGun.Crosshair_CarWeapon_MachineGun_C.GetOverloadWidget
// (Event, Protected, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UUserWidget*                 ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

class UUserWidget* UCrosshair_CarWeapon_MachineGun_C::GetOverloadWidget()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Crosshair_CarWeapon_MachineGun_C", "GetOverloadWidget");

	Params::UCrosshair_CarWeapon_MachineGun_C_GetOverloadWidget_Params Parms{};
...
// Function Crosshair_CarWeapon_MachineGun.Crosshair_CarWeapon_MachineGun_C.SetWidgetResources
// (Event, Protected, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UCrosshair_CarWeapon_MachineGun_C::SetWidgetResources(class UCanvasPanel** InSecondReticlePanel, class UImage** InReticleDirectionImage, class UImage** InRangedImage, class USizeBox** InAssistLockSizeBox, class UCanvasPanel** InChangeNewAssistLockPawnPanel, class UCanvasPanel** InEnterLockPawnPanel, class UCanvasPanel** InCanvas_Dynamic)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Crosshair_CarWeapon_MachineGun_C", "SetWidgetResources");

	Params::UCrosshair_CarWeapon_MachineGun_C_SetWidgetResources_Params Parms{};
