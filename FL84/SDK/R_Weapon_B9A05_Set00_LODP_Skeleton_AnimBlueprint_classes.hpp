...
public:
	...
	static class UR_Weapon_B9A05_Set00_LODP_Skeleton_AnimBlueprint_C* GetDefaultObj();

	void ExecuteUbergraph_R_Weapon_B9A05_Set00_LODP_Skeleton_AnimBlueprint(int32 bpp__EntryPoint__pf);
