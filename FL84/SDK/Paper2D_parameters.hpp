...
public:
	...
	uint8                                        Pad_23[0xC];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_24[0xC];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_25[0x2];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_28[0xE];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
