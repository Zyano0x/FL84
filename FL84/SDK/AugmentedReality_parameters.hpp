...
public:
	...
	uint8                                        Pad_1343[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_134B[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1405[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	enum class EAREye                            Eye;                                               // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1407[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
