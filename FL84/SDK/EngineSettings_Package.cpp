...
namespace CG
{
	...
	UClass* UConsoleSettings::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class EngineSettings.ConsoleSettings"));
		return ptr;
	}
	...
	void UGameMapsSettings::SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function EngineSettings.GameMapsSettings.SetSkipAssigningGamepadToPlayer1"));
	...
	bool UGameMapsSettings::GetSkipAssigningGamepadToPlayer1()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1"));
	...
	class UGameMapsSettings* UGameMapsSettings::STATIC_GetGameMapsSettings()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function EngineSettings.GameMapsSettings.GetGameMapsSettings"));
	...
	UClass* UGameMapsSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class EngineSettings.GameMapsSettings"));
		return ptr;
	}
	...
	UClass* UGameNetworkManagerSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class EngineSettings.GameNetworkManagerSettings"));
		return ptr;
	}
	...
	UClass* UGameSessionSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class EngineSettings.GameSessionSettings"));
		return ptr;
	}
	...
	UClass* UGeneralEngineSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class EngineSettings.GeneralEngineSettings"));
		return ptr;
	}
	...
	UClass* UGeneralProjectSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class EngineSettings.GeneralProjectSettings"));
		return ptr;
	}
	...
	UClass* UHudSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class EngineSettings.HudSettings"));
		return ptr;
	}
