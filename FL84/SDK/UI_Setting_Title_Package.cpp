...
namespace CG
{
	...
	void UUI_Setting_Title_C::PreConstruct(bool IsDesignTime)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Setting_Title.UI_Setting_Title_C.PreConstruct"));
	...
	void UUI_Setting_Title_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Setting_Title.UI_Setting_Title_C.Construct"));
	...
	void UUI_Setting_Title_C::ExecuteUbergraph_UI_Setting_Title(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Setting_Title.UI_Setting_Title_C.ExecuteUbergraph_UI_Setting_Title"));
	...
	UClass* UUI_Setting_Title_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("WidgetBlueprintGeneratedClass UI_Setting_Title.UI_Setting_Title_C"));
		return ptr;
	}
