...
namespace CG
{
	...
	public:
		...
		class UParticleSystemWidget*                               ParticleSystemWidget_97;                                 // 0x0410(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
