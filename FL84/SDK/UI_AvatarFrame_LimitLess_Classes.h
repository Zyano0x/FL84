...
namespace CG
{
	...
	public:
		...
		class UParticleSystemWidget*                               ParticleSystemWidget_97;                                 // 0x0358(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void Construct();
		void Update();
		void ExecuteUbergraph_UI_AvatarFrame_LimitLess(int32_t EntryPoint);
