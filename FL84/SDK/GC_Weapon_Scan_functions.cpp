...
class UClass* AGC_Weapon_Scan_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Weapon_Scan_C");

	return Clss;
}


// GC_Weapon_Scan_C GC_Weapon_Scan.Default__GC_Weapon_Scan_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Weapon_Scan_C* AGC_Weapon_Scan_C::GetDefaultObj()
{
	static class AGC_Weapon_Scan_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Weapon_Scan_C*>(AGC_Weapon_Scan_C::StaticClass()->DefaultObject);
...
// class ASolarPlayerController*      K2Node_DynamicCast_AsSolar_Player_Controller                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class ASolarCharacter*             CallFunc_GetViewportFocusedCharacter_ReturnValue                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AGC_Weapon_Scan_C::PlaySound(class ASolarCharacter* CueOwner, const struct FVector& CueLocation, class APlayerController* CallFunc_GetPlayerController_ReturnValue, int32 CallFunc_PostEventAtLocation_ReturnValue, class ASolarPlayerController* K2Node_DynamicCast_AsSolar_Player_Controller, bool K2Node_DynamicCast_bSuccess, int32 CallFunc_PostEventAtLocation_ReturnValue_1, class ASolarCharacter* CallFunc_GetViewportFocusedCharacter_ReturnValue, int32 CallFunc_PostEventAtLocation_ReturnValue_2, bool CallFunc_IsTeammateWith_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue)
{
	...
	Params::AGC_Weapon_Scan_C_PlaySound_Params Parms{};

	Parms.CueOwner = CueOwner;
	Parms.CueLocation = CueLocation;
	Parms.CallFunc_GetPlayerController_ReturnValue = CallFunc_GetPlayerController_ReturnValue;
	Parms.CallFunc_PostEventAtLocation_ReturnValue = CallFunc_PostEventAtLocation_ReturnValue;
	Parms.K2Node_DynamicCast_AsSolar_Player_Controller = K2Node_DynamicCast_AsSolar_Player_Controller;
	Parms.K2Node_DynamicCast_bSuccess = K2Node_DynamicCast_bSuccess;
	Parms.CallFunc_PostEventAtLocation_ReturnValue_1 = CallFunc_PostEventAtLocation_ReturnValue_1;
	Parms.CallFunc_GetViewportFocusedCharacter_ReturnValue = CallFunc_GetViewportFocusedCharacter_ReturnValue;
...
bool AGC_Weapon_Scan_C::OnActive(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, float CallFunc_BreakGameplayCueParameters_NormalizedMagnitude, float CallFunc_BreakGameplayCueParameters_RawMagnitude, const struct FGameplayEffectContextHandle& CallFunc_BreakGameplayCueParameters_EffectContext, const struct FGameplayTag& CallFunc_BreakGameplayCueParameters_MatchedTagName, const struct FGameplayTag& CallFunc_BreakGameplayCueParameters_OriginalTag, const struct FGameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedSourceTags, const struct FGameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedTargetTags, const struct FVector& CallFunc_BreakGameplayCueParameters_Location, const struct FVector& CallFunc_BreakGameplayCueParameters_Normal, class AActor* CallFunc_BreakGameplayCueParameters_Instigator, class AActor* CallFunc_BreakGameplayCueParameters_EffectCauser, class UObject* CallFunc_BreakGameplayCueParameters_SourceObject, class UPhysicalMaterial* CallFunc_BreakGameplayCueParameters_PhysicalMaterial, int32 CallFunc_BreakGameplayCueParameters_GameplayEffectLevel, int32 CallFunc_BreakGameplayCueParameters_AbilityLevel, class USceneComponent* CallFunc_BreakGameplayCueParameters_TargetAttachComponent, const struct FVector& CallFunc_Conv_FloatToVector_ReturnValue, const struct FVector& CallFunc_Divide_VectorFloat_ReturnValue, class ASolarCharacter* K2Node_DynamicCast_AsSolar_Character, bool K2Node_DynamicCast_bSuccess, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue)
{
	...
	Params::AGC_Weapon_Scan_C_OnActive_Params Parms{};
