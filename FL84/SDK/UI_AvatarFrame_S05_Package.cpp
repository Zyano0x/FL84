...
namespace CG
{
	...
	class FString UUI_AvatarFrame_S05_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.GetModuleName");
	...
	void UUI_AvatarFrame_S05_C::SetAvatarIcon(int32_t InAvatarID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.SetAvatarIcon");
	...
	void UUI_AvatarFrame_S05_C::SetEmptyState(bool IsEmpty)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.SetEmptyState");
	...
	void UUI_AvatarFrame_S05_C::SetPlayerGender(E_Type_Gender Gender)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.SetPlayerGender");
	...
	void UUI_AvatarFrame_S05_C::SetSocialIcon(E_Type_Social Social)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.SetSocialIcon");
	...
	void UUI_AvatarFrame_S05_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.PreConstruct");
	...
	void UUI_AvatarFrame_S05_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.Construct");
	...
	void UUI_AvatarFrame_S05_C::Update()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.Update");
	...
	void UUI_AvatarFrame_S05_C::ExecuteUbergraph_UI_AvatarFrame_S05(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.ExecuteUbergraph_UI_AvatarFrame_S05");
	...
	void UUI_AvatarFrame_S05_C::OnReleased__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.On Released__DelegateSignature");
	...
	void UUI_AvatarFrame_S05_C::OnClicked__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S05.UI_AvatarFrame_S05_C.On Clicked__DelegateSignature");
	...
	UClass* UUI_AvatarFrame_S05_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_AvatarFrame_S05.UI_AvatarFrame_S05_C");
		return ptr;
	}
