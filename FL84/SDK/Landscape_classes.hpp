...
public:
	...
	uint8                                        Pad_16BF[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_16C5[0x64];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_10D : 5;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_16E5[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_16ED[0x48];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_16F0[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_16F6[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_16FC[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1703[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_170B[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_170E[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	bool                                         bPrintLayerInfos;                                  // 0x3D(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_171B[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
