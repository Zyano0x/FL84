...
public:
	...
	static class AProjectile_BMphy0_Primary_C* GetDefaultObj();
	...
	void ExecuteUbergraph_Projectile_BMphy0_Primary(int32 EntryPoint, const struct FHitResult& K2Node_ComponentBoundEvent_ImpactResult);
};
