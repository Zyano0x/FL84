...
public:
	...
	uint8                                        Pad_1472[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        BitPad_113 : 1;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14B2[0x28];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14B3[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_14B6[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_14BE[0x170];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_14BF[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_14C4[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14C5[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14C6[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_14C8[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
