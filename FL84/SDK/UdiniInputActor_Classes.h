...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_RBF6[0x8];                                   // 0x0228(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5SJ3[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CJ5D[0x10];                                  // 0x0100(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_NFCL[0x1];                                   // 0x004B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B4II[0x99];                                  // 0x006F(0x0099) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZLBS[0x4];                                   // 0x011C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_WPGZ[0x3];                                   // 0x0125(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YKOL[0x8];                                   // 0x0118(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_883Q[0x4];                                   // 0x011C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XYTR[0x6];                                   // 0x015A(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Q4JF[0x4];                                   // 0x035C(0x0004) Fix Super Size
	...
	{
	public:
		unsigned char                                              UnknownData_CXNE[0x8];                                   // 0x0228(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_60IF[0x10];                                  // 0x0180(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_I443[0x16];                                  // 0x0192(0x0016) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_AIHK[0x20];                                  // 0x0630(0x0020) MISSED OFFSET (PADDING)
