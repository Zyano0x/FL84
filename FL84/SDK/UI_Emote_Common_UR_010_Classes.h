...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_Emote_Common_UR_010.UI_Emote_Common_UR_010_C
	 * Size -> 0x0030 (FullSize[0x0678] - InheritedSize[0x0648])
	 */
	class UUI_Emote_Common_UR_010_C : public UEmojiBubbleWidget
	{
	public:
	...
	public:
		...
		void Construct();
		void ExecuteUbergraph_UI_Emote_Common_UR_010(int32_t EntryPoint);
