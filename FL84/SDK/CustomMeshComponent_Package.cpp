...
namespace CG
{
	...
	bool UCustomMeshComponent::SetCustomMeshTriangles(TArray<struct FCustomMeshTriangle> Triangles)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CustomMeshComponent.CustomMeshComponent.SetCustomMeshTriangles"));
	...
	void UCustomMeshComponent::ClearCustomMeshTriangles()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CustomMeshComponent.CustomMeshComponent.ClearCustomMeshTriangles"));
	...
	void UCustomMeshComponent::AddCustomMeshTriangles(TArray<struct FCustomMeshTriangle> Triangles)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CustomMeshComponent.CustomMeshComponent.AddCustomMeshTriangles"));
	...
	UClass* UCustomMeshComponent::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CustomMeshComponent.CustomMeshComponent"));
		return ptr;
	}
