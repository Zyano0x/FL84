...
namespace CG
{
	...
	void UImgMediaSource::SetSequencePath(const class FString& Path)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ImgMedia.ImgMediaSource.SetSequencePath"));
	...
	class FString UImgMediaSource::GetSequencePath()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ImgMedia.ImgMediaSource.GetSequencePath"));
	...
	void UImgMediaSource::GetProxies(TArray<class FString>* OutProxies)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ImgMedia.ImgMediaSource.GetProxies"));
	...
	UClass* UImgMediaSource::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ImgMedia.ImgMediaSource"));
		return ptr;
	}
