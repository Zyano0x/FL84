...
namespace CG
{
	 ...
	 */
	struct AProjectile_Antivehicle_Weapon01_C_BndEvt__MovementComp_K2Node_ComponentBoundEvent_0_OnProjectileStopDelegate__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct AProjectile_Antivehicle_Weapon01_C_ExecuteUbergraph_Projectile_Antivehicle_Weapon01_Params
	{
	public:
