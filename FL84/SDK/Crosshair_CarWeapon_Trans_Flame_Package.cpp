...
namespace CG
{
	...
	void UCrosshair_CarWeapon_Trans_Flame_C::Construct()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C.Construct");
	...
	void UCrosshair_CarWeapon_Trans_Flame_C::OnTransformerWeaponChanged(ETransformerType InType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C.OnTransformerWeaponChanged");
	...
	void UCrosshair_CarWeapon_Trans_Flame_C::OnOverloadStateChanged(bool bEnter)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C.OnOverloadStateChanged");
	...
	void UCrosshair_CarWeapon_Trans_Flame_C::OnCrosshairInNormalState()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C.OnCrosshairInNormalState");
	...
	void UCrosshair_CarWeapon_Trans_Flame_C::ExecuteUbergraph_Crosshair_CarWeapon_Trans_Flame(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C.ExecuteUbergraph_Crosshair_CarWeapon_Trans_Flame");
	...
	UClass* UCrosshair_CarWeapon_Trans_Flame_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C");
		return ptr;
	}
