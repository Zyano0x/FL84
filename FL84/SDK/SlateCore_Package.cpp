...
namespace CG
{
	...
	UClass* UFontBulkData::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class SlateCore.FontBulkData"));
		return ptr;
	}
	...
	UClass* UFontFaceInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class SlateCore.FontFaceInterface"));
		return ptr;
	}
	...
	UClass* UFontProviderInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class SlateCore.FontProviderInterface"));
		return ptr;
	}
	...
	UClass* USlateTypes::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class SlateCore.SlateTypes"));
		return ptr;
	}
	...
	UClass* USlateWidgetStyleAsset::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class SlateCore.SlateWidgetStyleAsset"));
		return ptr;
	}
	...
	UClass* USlateWidgetStyleContainerBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class SlateCore.SlateWidgetStyleContainerBase"));
		return ptr;
	}
	...
	UClass* USlateWidgetStyleContainerInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class SlateCore.SlateWidgetStyleContainerInterface"));
		return ptr;
	}
