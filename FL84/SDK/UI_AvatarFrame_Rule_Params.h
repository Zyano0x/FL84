...
namespace CG
{
	 ...
	 */
	struct UUI_AvatarFrame_Rule_C_Construct_Params
	{	};

	/**
	 * Function UI_AvatarFrame_Rule.UI_AvatarFrame_Rule_C.Update
	 */
	struct UUI_AvatarFrame_Rule_C_Update_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_UXG2[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function UI_AvatarFrame_Rule.UI_AvatarFrame_Rule_C.On Released__DelegateSignature
	 */
	struct UUI_AvatarFrame_Rule_C_OnReleased__DelegateSignature_Params
	{	};

	/**
	 * Function UI_AvatarFrame_Rule.UI_AvatarFrame_Rule_C.On Clicked__DelegateSignature
	 */
	struct UUI_AvatarFrame_Rule_C_OnClicked__DelegateSignature_Params
	{	};
