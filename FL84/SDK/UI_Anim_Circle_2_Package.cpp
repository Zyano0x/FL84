...
namespace CG
{
	...
	void UUI_Anim_Circle_1_C::Construct()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Anim_Circle_2.UI_Anim_Circle_1_C.Construct");
	...
	void UUI_Anim_Circle_1_C::PlayLoadingAnim()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Anim_Circle_2.UI_Anim_Circle_1_C.PlayLoadingAnim");
	...
	void UUI_Anim_Circle_1_C::StopLoadingAnim()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Anim_Circle_2.UI_Anim_Circle_1_C.StopLoadingAnim");
	...
	void UUI_Anim_Circle_1_C::ExecuteUbergraph_UI_Anim_Circle_2(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Anim_Circle_2.UI_Anim_Circle_1_C.ExecuteUbergraph_UI_Anim_Circle_2");
	...
	UClass* UUI_Anim_Circle_1_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Anim_Circle_2.UI_Anim_Circle_1_C");
		return ptr;
	}
