...
namespace CG
{
	...
	class FString UUI_Component_Emoji_Item_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_Emoji_Item.UI_Component_Emoji_Item_C.GetModuleName"));
	...
	void UUI_Component_Emoji_Item_C::SetQuality(E_Item_Quality Quality)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_Emoji_Item.UI_Component_Emoji_Item_C.SetQuality"));
	...
	void UUI_Component_Emoji_Item_C::BP_OnEntryReleased()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_Emoji_Item.UI_Component_Emoji_Item_C.BP_OnEntryReleased"));
	...
	void UUI_Component_Emoji_Item_C::BP_OnItemExpansionChanged(bool bIsExpanded)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_Emoji_Item.UI_Component_Emoji_Item_C.BP_OnItemExpansionChanged"));
	...
	void UUI_Component_Emoji_Item_C::BP_OnItemSelectionChanged(bool bIsSelected)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_Emoji_Item.UI_Component_Emoji_Item_C.BP_OnItemSelectionChanged"));
	...
	void UUI_Component_Emoji_Item_C::OnListItemObjectSet(class UObject* ListItemObject)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_Emoji_Item.UI_Component_Emoji_Item_C.OnListItemObjectSet"));
	...
	void UUI_Component_Emoji_Item_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_Emoji_Item.UI_Component_Emoji_Item_C.PreConstruct"));
	...
	void UUI_Component_Emoji_Item_C::ExecuteUbergraph_UI_Component_Emoji_Item(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_Emoji_Item.UI_Component_Emoji_Item_C.ExecuteUbergraph_UI_Component_Emoji_Item"));
	...
	UClass* UUI_Component_Emoji_Item_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("WidgetBlueprintGeneratedClass UI_Component_Emoji_Item.UI_Component_Emoji_Item_C"));
		return ptr;
	}
