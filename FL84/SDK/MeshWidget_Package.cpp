...
namespace CG
{
	...
	UClass* UMeshWidgetUWidget::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("Class MeshWidget.MeshWidgetUWidget");
		return ptr;
	}
	...
	UClass* UParticleWidget::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class MeshWidget.ParticleWidget");
		return ptr;
	}
	...
	void UMeshRectangleWidget::SetInstanceNum(int32_t NewNum)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MeshWidget.MeshRectangleWidget.SetInstanceNum");
	...
	void UMeshRectangleWidget::ModifyInstanceNum(int32_t dNum)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MeshWidget.MeshRectangleWidget.ModifyInstanceNum");
	...
	void UMeshRectangleWidget::InitUnitTestProvider()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function MeshWidget.MeshRectangleWidget.InitUnitTestProvider");
	...
	UClass* UMeshRectangleWidget::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class MeshWidget.MeshRectangleWidget");
		return ptr;
	}
	...
	UClass* UTextMeshWidget::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class MeshWidget.TextMeshWidget");
		return ptr;
	}
	...
	UClass* UProgressBarMeshWidget::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class MeshWidget.ProgressBarMeshWidget");
		return ptr;
	}
