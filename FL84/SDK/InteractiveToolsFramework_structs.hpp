...
{
public:
	uint8                                        Pad_1777[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1778[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1779[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_177C[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
