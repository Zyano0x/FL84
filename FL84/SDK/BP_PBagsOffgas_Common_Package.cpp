...
namespace CG
{
	...
	void ABP_PBagsOffgas_Common_C::BackpackSFXBegin(EFXJetType InJetType, bool GroundDetected)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_PBagsOffgas_Common.BP_PBagsOffgas_Common_C.BackpackSFXBegin");
	...
	void ABP_PBagsOffgas_Common_C::BackpackSFXEnd()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_PBagsOffgas_Common.BP_PBagsOffgas_Common_C.BackpackSFXEnd");
	...
	void ABP_PBagsOffgas_Common_C::OnBackpackTrailAssembling(const struct FBackpackTrailAssemblingParams& Params, EBackpackPropellingMode PropellingMode)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_PBagsOffgas_Common.BP_PBagsOffgas_Common_C.OnBackpackTrailAssembling");
	...
	void ABP_PBagsOffgas_Common_C::ExecuteUbergraph_BP_PBagsOffgas_Common(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_PBagsOffgas_Common.BP_PBagsOffgas_Common_C.ExecuteUbergraph_BP_PBagsOffgas_Common");
	...
	UClass* ABP_PBagsOffgas_Common_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_PBagsOffgas_Common.BP_PBagsOffgas_Common_C");
		return ptr;
	}
