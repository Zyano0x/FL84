...
void UUI_Component_ReturnBtn_C::ExecuteUbergraph_UI_Component_ReturnBtn(int32 EntryPoint, int32 CallFunc_PlaySound2D_ReturnValue, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, bool K2Node_Event_IsDesignTime, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
