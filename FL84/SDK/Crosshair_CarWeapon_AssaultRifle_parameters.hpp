...
struct UCrosshair_CarWeapon_AssaultRifle_C_GetAmmoWidget_Params
{
public:
...
struct UCrosshair_CarWeapon_AssaultRifle_C_GetReloadWidget_Params
{
public:
	class UUserWidget*                           ReturnValue;                                       // 0x0(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UCrosshair_CarWeapon_AssaultRifle_C_SetWidgetResources_Params
{
public:
