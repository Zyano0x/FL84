...
namespace CG
{
	...
	UClass* UFoliageInstancedStaticMeshComponent::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.FoliageInstancedStaticMeshComponent"));
		return ptr;
	}
	...
	int32_t UFoliageStatistics::STATIC_FoliageOverlappingSphereCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, const struct FVector& CenterPosition, float Radius)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function Foliage.FoliageStatistics.FoliageOverlappingSphereCount"));
	...
	int32_t UFoliageStatistics::STATIC_FoliageOverlappingBoxCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, const struct FBox& Box)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function Foliage.FoliageStatistics.FoliageOverlappingBoxCount"));
	...
	UClass* UFoliageStatistics::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.FoliageStatistics"));
		return ptr;
	}
	...
	UClass* UFoliageType::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.FoliageType"));
		return ptr;
	}
	...
	UClass* UFoliageType_Actor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.FoliageType_Actor"));
		return ptr;
	}
	...
	UClass* UFoliageType_InstancedStaticMesh::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.FoliageType_InstancedStaticMesh"));
		return ptr;
	}
	...
	UClass* AInstancedFoliageActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.InstancedFoliageActor"));
		return ptr;
	}
	...
	void AInteractiveFoliageActor::CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& OverlapInfo)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function Foliage.InteractiveFoliageActor.CapsuleTouched"));
	...
	UClass* AInteractiveFoliageActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.InteractiveFoliageActor"));
		return ptr;
	}
	...
	UClass* UInteractiveFoliageComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.InteractiveFoliageComponent"));
		return ptr;
	}
	...
	UClass* AProceduralFoliageBlockingVolume::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.ProceduralFoliageBlockingVolume"));
		return ptr;
	}
	...
	UClass* UProceduralFoliageComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.ProceduralFoliageComponent"));
		return ptr;
	}
	...
	void UProceduralFoliageSpawner::Simulate(int32_t NumSteps)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function Foliage.ProceduralFoliageSpawner.Simulate"));
	...
	UClass* UProceduralFoliageSpawner::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.ProceduralFoliageSpawner"));
		return ptr;
	}
	...
	UClass* UProceduralFoliageTile::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.ProceduralFoliageTile"));
		return ptr;
	}
	...
	UClass* AProceduralFoliageVolume::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Foliage.ProceduralFoliageVolume"));
		return ptr;
	}
