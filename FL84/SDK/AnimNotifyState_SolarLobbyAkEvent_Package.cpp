...
namespace CG
{
	...
	void UAnimNotifyState_SolarLobbyAkEvent_C::AKEventFun(class USkeletalMeshComponent* SkeletalMeshComp, class UAkAudioEvent* Event, const class FString& EventName, bool isNotifyEnd, bool* ReturnValue)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimNotifyState_SolarLobbyAkEvent.AnimNotifyState_SolarLobbyAkEvent_C.AK Event Fun"));
	...
	void UAnimNotifyState_SolarLobbyAkEvent_C::GetMeshAKComponent(class USkeletalMeshComponent* InSkeletalMeshComp, class UAkComponent** OutAkComp, bool* IsSuccess)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimNotifyState_SolarLobbyAkEvent.AnimNotifyState_SolarLobbyAkEvent_C.Get Mesh AK Component"));
	...
	void UAnimNotifyState_SolarLobbyAkEvent_C::GetAkSwitch(class USkeletalMeshComponent* InSkeletalMeshComp, bool* ShouldPlaySounds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimNotifyState_SolarLobbyAkEvent.AnimNotifyState_SolarLobbyAkEvent_C.GetAkSwitch"));
	...
	bool UAnimNotifyState_SolarLobbyAkEvent_C::Received_NotifyEnd(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimNotifyState_SolarLobbyAkEvent.AnimNotifyState_SolarLobbyAkEvent_C.Received_NotifyEnd"));
	...
	bool UAnimNotifyState_SolarLobbyAkEvent_C::Received_NotifyBegin(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float TotalDuration)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function AnimNotifyState_SolarLobbyAkEvent.AnimNotifyState_SolarLobbyAkEvent_C.Received_NotifyBegin"));
	...
	UClass* UAnimNotifyState_SolarLobbyAkEvent_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("BlueprintGeneratedClass AnimNotifyState_SolarLobbyAkEvent.AnimNotifyState_SolarLobbyAkEvent_C"));
		return ptr;
	}
