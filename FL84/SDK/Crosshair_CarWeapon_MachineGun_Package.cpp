...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x0260DF10
	 * 		Name   -> Function Crosshair_CarWeapon_MachineGun.Crosshair_CarWeapon_MachineGun_C.GetReloadWidget
	...
	class UUserWidget* UCrosshair_CarWeapon_MachineGun_C::GetReloadWidget()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Crosshair_CarWeapon_MachineGun.Crosshair_CarWeapon_MachineGun_C.GetReloadWidget");
		
		UCrosshair_CarWeapon_MachineGun_C_GetReloadWidget_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x0260DF10
	 * 		Name   -> Function Crosshair_CarWeapon_MachineGun.Crosshair_CarWeapon_MachineGun_C.GetOverloadWidget
	 * 		Flags  -> (Event, Protected, HasOutParms, BlueprintCallable, BlueprintEvent)
	 */
	class UUserWidget* UCrosshair_CarWeapon_MachineGun_C::GetOverloadWidget()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Crosshair_CarWeapon_MachineGun.Crosshair_CarWeapon_MachineGun_C.GetOverloadWidget");
		
		UCrosshair_CarWeapon_MachineGun_C_GetOverloadWidget_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x0260DF10
	 * 		Name   -> Function Crosshair_CarWeapon_MachineGun.Crosshair_CarWeapon_MachineGun_C.SetWidgetResources
	 * 		Flags  -> (Event, Protected, HasOutParms, BlueprintCallable, BlueprintEvent)
	 * Parameters:
	...
	void UCrosshair_CarWeapon_MachineGun_C::SetWidgetResources(class UCanvasPanel** InSecondReticlePanel, class UImage** InReticleDirectionImage, class UImage** InRangedImage, class USizeBox** InAssistLockSizeBox, class UCanvasPanel** InChangeNewAssistLockPawnPanel, class UCanvasPanel** InEnterLockPawnPanel, class UCanvasPanel** InCanvas_Dynamic)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Crosshair_CarWeapon_MachineGun.Crosshair_CarWeapon_MachineGun_C.SetWidgetResources");
		
		UCrosshair_CarWeapon_MachineGun_C_SetWidgetResources_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UCrosshair_CarWeapon_MachineGun_C.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UCrosshair_CarWeapon_MachineGun_C::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Crosshair_CarWeapon_MachineGun.Crosshair_CarWeapon_MachineGun_C");
		return ptr;
	}
