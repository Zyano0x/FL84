...
namespace CG
{
	...
	class FString UUI_Target_Card_Medal_Item_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Target_Card_Medal_Item.UI_Target_Card_Medal_Item_C.GetModuleName");
	...
	void UUI_Target_Card_Medal_Item_C::BPCalLuaInitData(int32_t ID, int32_t Type, int32_t Level)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Target_Card_Medal_Item.UI_Target_Card_Medal_Item_C.BPCalLuaInitData");
	...
	void UUI_Target_Card_Medal_Item_C::SetSmallIcon(class UTexture2D* NewParam, bool NewParam1)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Target_Card_Medal_Item.UI_Target_Card_Medal_Item_C.SetSmallIcon");
	...
	void UUI_Target_Card_Medal_Item_C::SetLargeIcon(class UTexture2D* NewParam1, bool NewParam)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Target_Card_Medal_Item.UI_Target_Card_Medal_Item_C.SetLargeIcon");
	...
	void UUI_Target_Card_Medal_Item_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Target_Card_Medal_Item.UI_Target_Card_Medal_Item_C.PreConstruct");
	...
	void UUI_Target_Card_Medal_Item_C::ChangeTargetCardMedalView(int32_t ID, int32_t Type, int32_t Level)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Target_Card_Medal_Item.UI_Target_Card_Medal_Item_C.ChangeTargetCardMedalView");
	...
	void UUI_Target_Card_Medal_Item_C::ExecuteUbergraph_UI_Target_Card_Medal_Item(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Target_Card_Medal_Item.UI_Target_Card_Medal_Item_C.ExecuteUbergraph_UI_Target_Card_Medal_Item");
	...
	UClass* UUI_Target_Card_Medal_Item_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Target_Card_Medal_Item.UI_Target_Card_Medal_Item_C");
		return ptr;
	}
