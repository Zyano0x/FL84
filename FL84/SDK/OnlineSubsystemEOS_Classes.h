...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1Y4H[0x1];                                   // 0x004F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PN7O[0x4];                                   // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J0IT[0x2];                                   // 0x007E(0x0002) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HVHC[0x8];                                   // 0x1BB0(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VPLD[0x6];                                   // 0x07CA(0x0006) MISSED OFFSET (PADDING)
