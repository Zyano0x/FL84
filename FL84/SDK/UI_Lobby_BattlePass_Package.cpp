...
namespace CG
{
	...
	class FString UUI_Lobby_BattlePass_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass.UI_Lobby_BattlePass_C.GetModuleName");
	...
	void UUI_Lobby_BattlePass_C::SetClaimable(bool Claimable)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass.UI_Lobby_BattlePass_C.SetClaimable");
	...
	void UUI_Lobby_BattlePass_C::SetUpdate(bool Update)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass.UI_Lobby_BattlePass_C.SetUpdate");
	...
	void UUI_Lobby_BattlePass_C::SetLevel(bool Max)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass.UI_Lobby_BattlePass_C.SetLevel");
	...
	void UUI_Lobby_BattlePass_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass.UI_Lobby_BattlePass_C.PreConstruct");
	...
	void UUI_Lobby_BattlePass_C::BattlePassStateChange_Event()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass.UI_Lobby_BattlePass_C.BattlePassStateChange_Event");
	...
	void UUI_Lobby_BattlePass_C::BattlePassPlayUpgradeAnimation()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass.UI_Lobby_BattlePass_C.BattlePassPlayUpgradeAnimation");
	...
	void UUI_Lobby_BattlePass_C::ExecuteUbergraph_UI_Lobby_BattlePass(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass.UI_Lobby_BattlePass_C.ExecuteUbergraph_UI_Lobby_BattlePass");
	...
	UClass* UUI_Lobby_BattlePass_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Lobby_BattlePass.UI_Lobby_BattlePass_C");
		return ptr;
	}
