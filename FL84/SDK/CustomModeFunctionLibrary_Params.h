...
namespace CG
{
	 ...
	 */
	struct UCustomModeFunctionLibrary_C_LetPlayerOut_Params
	{
	public:
	 ...
	 */
	struct UCustomModeFunctionLibrary_C_ABindOnBasicSystemReady_Params
	{
	public:
	 ...
	 */
	struct UCustomModeFunctionLibrary_C_sGetPlayerManager_Params
	{
	public:
