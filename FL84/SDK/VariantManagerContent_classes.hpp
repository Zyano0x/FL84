...
public:
	...
	uint8                                        Pad_8F2[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_90A[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_90D[0x6F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_90F[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_914[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	class FText                                  DisplayText;                                       // 0x28(0x18)(Deprecated, NativeAccessSpecifierPrivate)
	uint8                                        Pad_91D[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
