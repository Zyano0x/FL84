...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_JEF5[0x70];                                  // 0x0058(0x0070) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WD8T[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
