...
namespace CG
{
	...
	UClass* UOverlays::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Overlay.Overlays"));
		return ptr;
	}
	...
	UClass* UBasicOverlays::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Overlay.BasicOverlays"));
		return ptr;
	}
	...
	UClass* ULocalizedOverlays::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class Overlay.LocalizedOverlays"));
		return ptr;
	}
