...
namespace CG
{
	...
	void UUnLuaManager::OnActorDestroyed(class AActor* Actor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaManager.OnActorDestroyed");
	...
	void AUnLuaPerformanceTestProxy::UpdatePositions(TArray<struct FVector> NewPositions)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.UpdatePositions");
	...
	class FString AUnLuaPerformanceTestProxy::UpdateMeshName(const class FString& NewName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.UpdateMeshName");
	...
	int32_t AUnLuaPerformanceTestProxy::UpdateMeshID(int32_t NewID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.UpdateMeshID");
	...
	void AUnLuaPerformanceTestProxy::UpdateIndices(TArray<int32_t> NewIndices)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.UpdateIndices");
	...
	void AUnLuaPerformanceTestProxy::Simulate(float DeltaTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.Simulate");
	...
	bool AUnLuaPerformanceTestProxy::Raycast(const struct FVector& Origin, const struct FVector& Direction)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.Raycast");
	...
	void AUnLuaPerformanceTestProxy::NOP()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.NOP");
	...
	TArray<struct FVector> AUnLuaPerformanceTestProxy::GetPredictedPositions()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.GetPredictedPositions");
	...
	void AUnLuaPerformanceTestProxy::GetPositions(TArray<struct FVector>* OutPositions)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.GetPositions");
	...
	class FString AUnLuaPerformanceTestProxy::GetMeshName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.GetMeshName");
	...
	bool AUnLuaPerformanceTestProxy::GetMeshInfo(int32_t* OutMeshID, class FString* OutMeshName, struct FVector* OutCOM, TArray<int32_t>* OutIndices, TArray<struct FVector>* OutPositions, TArray<struct FVector>* OutPredictedPositions)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.GetMeshInfo");
	...
	int32_t AUnLuaPerformanceTestProxy::GetMeshID()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.GetMeshID");
	...
	void AUnLuaPerformanceTestProxy::GetIndices(TArray<int32_t>* OutIndices)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.GetIndices");
	...
	struct FVector AUnLuaPerformanceTestProxy::GetCOM()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UnLua.UnLuaPerformanceTestProxy.GetCOM");
	...
	UClass* AUnLuaPerformanceTestProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class UnLua.UnLuaPerformanceTestProxy");
		return ptr;
	}
