...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_AvatarFrame_S14.UI_AvatarFrame_S14_C
	 * Size -> 0x0038 (FullSize[0x0438] - InheritedSize[0x0400])
	 */
	class UUI_AvatarFrame_S14_C : public USolarUserWidget
	{
	public:
	...
	public:
		...
		void Construct();
		void Update();
		void ExecuteUbergraph_UI_AvatarFrame_S14(int32_t EntryPoint);
