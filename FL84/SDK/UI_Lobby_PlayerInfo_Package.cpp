...
namespace CG
{
	...
	class FString UUI_Lobby_PlayerInfo_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_PlayerInfo.UI_Lobby_PlayerInfo_C.GetModuleName");
	...
	UClass* UUI_Lobby_PlayerInfo_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Lobby_PlayerInfo.UI_Lobby_PlayerInfo_C");
		return ptr;
	}
