...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_KOYL[0x590];                                 // 0x0028(0x0590) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_SWOF[0x8];                                   // 0x0228(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JT5M[0x4];                                   // 0x0234(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IABO[0x4];                                   // 0x0254(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
