...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_EV67[0x6];                                   // 0x0142(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3JH7[0x10];                                  // 0x0158(0x0010) MISSED OFFSET (PADDING)
