...
class UClass* UCrosshair_CarWeapon_Lava_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Crosshair_CarWeapon_Lava_C");

	return Clss;
}


// Crosshair_CarWeapon_Lava_C Crosshair_CarWeapon_Lava.Default__Crosshair_CarWeapon_Lava_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCrosshair_CarWeapon_Lava_C* UCrosshair_CarWeapon_Lava_C::GetDefaultObj()
{
	static class UCrosshair_CarWeapon_Lava_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCrosshair_CarWeapon_Lava_C*>(UCrosshair_CarWeapon_Lava_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Crosshair_CarWeapon_Lava.Crosshair_CarWeapon_Lava_C.SetWidgetResources
