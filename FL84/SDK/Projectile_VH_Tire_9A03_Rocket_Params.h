...
namespace CG
{
	 ...
	 */
	struct AProjectile_VH_Tire_9A03_Rocket_C_BndEvt__MovementComp_K2Node_ComponentBoundEvent_0_OnProjectileStopDelegate__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct AProjectile_VH_Tire_9A03_Rocket_C_ExecuteUbergraph_Projectile_VH_Tire_9A03_Rocket_Params
	{
	public:
