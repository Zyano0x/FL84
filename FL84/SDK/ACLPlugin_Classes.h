...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_Z8YU[0x108];                                 // 0x0048(0x0108) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4X3Y[0x4];                                   // 0x0154(0x0004) MISSED OFFSET (PADDING)
