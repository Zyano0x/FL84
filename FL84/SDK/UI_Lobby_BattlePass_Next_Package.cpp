...
namespace CG
{
	...
	class FString UUI_Lobby_BattlePass_Next_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass_Next.UI_Lobby_BattlePass_Next_C.GetModuleName");
	...
	void UUI_Lobby_BattlePass_Next_C::SetClaimable(bool NewParam)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass_Next.UI_Lobby_BattlePass_Next_C.SetClaimable");
	...
	void UUI_Lobby_BattlePass_Next_C::SetUpdate(bool NewParam)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass_Next.UI_Lobby_BattlePass_Next_C.SetUpdate");
	...
	void UUI_Lobby_BattlePass_Next_C::SetLevel(bool NewParam)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass_Next.UI_Lobby_BattlePass_Next_C.SetLevel");
	...
	void UUI_Lobby_BattlePass_Next_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass_Next.UI_Lobby_BattlePass_Next_C.PreConstruct");
	...
	void UUI_Lobby_BattlePass_Next_C::BattlePassStateChange_Event()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass_Next.UI_Lobby_BattlePass_Next_C.BattlePassStateChange_Event");
	...
	void UUI_Lobby_BattlePass_Next_C::BattlePassPlayUpgradeAnimation()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass_Next.UI_Lobby_BattlePass_Next_C.BattlePassPlayUpgradeAnimation");
	...
	void UUI_Lobby_BattlePass_Next_C::ExecuteUbergraph_UI_Lobby_BattlePass_Next(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_BattlePass_Next.UI_Lobby_BattlePass_Next_C.ExecuteUbergraph_UI_Lobby_BattlePass_Next");
	...
	UClass* UUI_Lobby_BattlePass_Next_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Lobby_BattlePass_Next.UI_Lobby_BattlePass_Next_C");
		return ptr;
	}
