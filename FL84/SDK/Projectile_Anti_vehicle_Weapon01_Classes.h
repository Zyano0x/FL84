...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Projectile_Anti_vehicle_Weapon01.Projectile_Anti-vehicle_Weapon01_C
	 * Size -> 0x0008 (FullSize[0x0510] - InheritedSize[0x0508])
	 */
	class AProjectile_Antivehicle_Weapon01_C : public ADefaultProjBullet_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Projectile_Antivehicle_Weapon01(int32_t EntryPoint);
