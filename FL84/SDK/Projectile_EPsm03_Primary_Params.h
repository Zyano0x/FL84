...
namespace CG
{
	 ...
	 */
	struct AProjectile_EPsm03_Primary_C_BndEvt__MovementComp_K2Node_ComponentBoundEvent_0_OnProjectileStopDelegate__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct AProjectile_EPsm03_Primary_C_ExecuteUbergraph_Projectile_EPsm03_Primary_Params
	{
	public:
