...
namespace CG
{
	...
	void UFX_Widget_Buff_AbilityIncrease_C::Construct()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FX_Widget_Buff_AbilityIncrease.FX_Widget_Buff_AbilityIncrease_C.Construct");
	...
	void UFX_Widget_Buff_AbilityIncrease_C::ExecuteUbergraph_FX_Widget_Buff_AbilityIncrease(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function FX_Widget_Buff_AbilityIncrease.FX_Widget_Buff_AbilityIncrease_C.ExecuteUbergraph_FX_Widget_Buff_AbilityIncrease");
	...
	UClass* UFX_Widget_Buff_AbilityIncrease_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass FX_Widget_Buff_AbilityIncrease.FX_Widget_Buff_AbilityIncrease_C");
		return ptr;
	}
