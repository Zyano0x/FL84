...
namespace CG
{
	...
	void UAnoSDK::OnAnoSentAntiData__DelegateSignature(const struct FAnoSDKAntiData& AntiData)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("DelegateFunction AnoSDK.AnoSDK.OnAnoSentAntiData__DelegateSignature");
	...
	void UAnoSDK::OnAnoRecvAntiData__DelegateSignature(int32_t Type, const class FString& AntiData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("DelegateFunction AnoSDK.AnoSDK.OnAnoRecvAntiData__DelegateSignature");
	...
	class UAnoSDK* UAnoSDK::STATIC_GetInstance()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.GetInstance");
	...
	void UAnoSDK::STATIC_DestoryInstance()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.DestoryInstance");
	...
	void UAnoSDK::STATIC_AnoUESDKSetUserInfo(ETssSDKEntryId EntryId, const class FString& OpenId)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKSetUserInfo");
	...
	void UAnoSDK::STATIC_AnoUESDKSetCSChannelDomain(const class FString& DomainName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKSetCSChannelDomain");
	...
	void UAnoSDK::STATIC_AnoUESDKSetChannelIP(const class FString& IP)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKSetChannelIP");
	...
	void UAnoSDK::STATIC_AnoUESDKSendSDKCoreData()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKSendSDKCoreData");
	...
	void UAnoSDK::STATIC_AnoUESDKSendDataToSvr()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKSendDataToSvr");
	...
	void UAnoSDK::STATIC_AnoUESDKSendCoreTimeData()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKSendCoreTimeData");
	...
	void UAnoSDK::STATIC_AnoUESDKReportThreadShutDown()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKReportThreadShutDown");
	...
	void UAnoSDK::STATIC_AnoUESDKReportThreadInit()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKReportThreadInit");
	...
	void UAnoSDK::STATIC_AnoUESDKRegistInfoListener()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKRegistInfoListener");
	...
	void UAnoSDK::STATIC_AnoUESDKOnResume()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKOnResume");
	...
	void UAnoSDK::STATIC_AnoUESDKOnRecvSignature(const class FString& Name, const class FString& Buf, int32_t Len, int32_t Crc)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKOnRecvSignature");
	...
	void UAnoSDK::STATIC_AnoUESDKOnRecvData(const class FString& Data)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKOnRecvData");
	...
	void UAnoSDK::STATIC_AnoUESDKOnPause()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKOnPause");
	...
	void UAnoSDK::STATIC_AnoUESDKIoctl(int32_t Request, const class FString& Cmd)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKIoctl");
	...
	void UAnoSDK::STATIC_AnoUESDKInit(int32_t GameID, const class FString& Appkey)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AnoSDK.AnoSDK.AnoUESDKInit");
	...
	UClass* UAnoSDK::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("Class AnoSDK.AnoSDK");
		return ptr;
	}
	...
	UClass* UAnoSDKSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class AnoSDK.AnoSDKSettings");
		return ptr;
	}
