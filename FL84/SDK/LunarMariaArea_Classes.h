...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4UYB[0x3];                                   // 0x003D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_OY2V[0x7];                                   // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OT04[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UIIA[0x58];                                  // 0x0158(0x0058) MISSED OFFSET (PADDING)
