...
namespace CG
{
	 ...
	 */
	struct UCrosshair_CarWeapon_Trans_MachineGun_C_Construct_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_Y0TE[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
