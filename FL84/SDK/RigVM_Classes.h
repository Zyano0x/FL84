...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_G6OB[0x10];                                  // 0x0198(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PSS7[0x38];                                  // 0x0208(0x0038) MISSED OFFSET (PADDING)
