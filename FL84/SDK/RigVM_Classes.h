...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_FKNZ[0x10];                                  // 0x0198(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MAAX[0x38];                                  // 0x0208(0x0038) MISSED OFFSET (PADDING)
