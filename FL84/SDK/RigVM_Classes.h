...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4XSU[0x10];                                  // 0x0198(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_05L6[0x38];                                  // 0x0208(0x0038) MISSED OFFSET (PADDING)
