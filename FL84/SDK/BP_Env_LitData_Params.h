...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_SWBZ[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	{
	public:
		struct FStr_EdgeLightSetting                               EdgeLightSetting;                                        // 0x0000(0x0030)  (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
	};
	...
	public:
		...
		struct FStr_DirectionalLightSetting                        Str_DirectionalLightSetting;                             // 0x0008(0x0038)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
	};
	...
	public:
		...
		struct FStr_SkyLightSetting                                Str_SkyLightSetting;                                     // 0x0008(0x0008)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
	};
