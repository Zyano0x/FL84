...
namespace CG
{
	...
	void UGameplayTasksComponent::OnRep_SimulatedTasks()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GameplayTasks.GameplayTasksComponent.OnRep_SimulatedTasks"));
	...
	EGameplayTaskRunResult UGameplayTasksComponent::STATIC_K2_RunGameplayTask(class UGameplayTask* Task, unsigned char Priority, TArray<class UClass*> AdditionalRequiredResources, TArray<class UClass*> AdditionalClaimedResources)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GameplayTasks.GameplayTasksComponent.K2_RunGameplayTask"));
	...
	UClass* UGameplayTasksComponent::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GameplayTasks.GameplayTasksComponent"));
		return ptr;
	}
	...
	void UGameplayTask::ReadyForActivation()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GameplayTasks.GameplayTask.ReadyForActivation"));
	...
	void UGameplayTask::GenericGameplayTaskDelegate__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("DelegateFunction GameplayTasks.GameplayTask.GenericGameplayTaskDelegate__DelegateSignature"));
	...
	void UGameplayTask::EndTask()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GameplayTasks.GameplayTask.EndTask"));
	...
	UClass* UGameplayTask::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GameplayTasks.GameplayTask"));
		return ptr;
	}
	...
	class UGameplayTask_ClaimResource* UGameplayTask_ClaimResource::STATIC_ClaimResources(TArray<class UClass*> ResourceClasses, unsigned char Priority, const class FName& TaskInstanceName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GameplayTasks.GameplayTask_ClaimResource.ClaimResources"));
	...
	class UGameplayTask_ClaimResource* UGameplayTask_ClaimResource::STATIC_ClaimResource(class UClass* ResourceClass, unsigned char Priority, const class FName& TaskInstanceName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GameplayTasks.GameplayTask_ClaimResource.ClaimResource"));
	...
	UClass* UGameplayTask_ClaimResource::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GameplayTasks.GameplayTask_ClaimResource"));
		return ptr;
	}
	...
	class UGameplayTask_SpawnActor* UGameplayTask_SpawnActor::STATIC_SpawnActor(const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation, class UClass* Class, bool bSpawnOnlyOnAuthority)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GameplayTasks.GameplayTask_SpawnActor.SpawnActor"));
	...
	void UGameplayTask_SpawnActor::FinishSpawningActor(class UObject* WorldContextObject, class AActor* SpawnedActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GameplayTasks.GameplayTask_SpawnActor.FinishSpawningActor"));
	...
	bool UGameplayTask_SpawnActor::BeginSpawningActor(class UObject* WorldContextObject, class AActor** SpawnedActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GameplayTasks.GameplayTask_SpawnActor.BeginSpawningActor"));
	...
	UClass* UGameplayTask_SpawnActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GameplayTasks.GameplayTask_SpawnActor"));
		return ptr;
	}
	...
	UClass* UGameplayTask_TimeLimitedExecution::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GameplayTasks.GameplayTask_TimeLimitedExecution"));
		return ptr;
	}
	...
	class UGameplayTask_WaitDelay* UGameplayTask_WaitDelay::STATIC_TaskWaitDelay(float Time, unsigned char Priority)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GameplayTasks.GameplayTask_WaitDelay.TaskWaitDelay"));
	...
	void UGameplayTask_WaitDelay::TaskDelayDelegate__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("DelegateFunction GameplayTasks.GameplayTask_WaitDelay.TaskDelayDelegate__DelegateSignature"));
	...
	UClass* UGameplayTask_WaitDelay::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GameplayTasks.GameplayTask_WaitDelay"));
		return ptr;
	}
	...
	UClass* UGameplayTaskOwnerInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GameplayTasks.GameplayTaskOwnerInterface"));
		return ptr;
	}
	...
	UClass* UGameplayTaskResource::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GameplayTasks.GameplayTaskResource"));
		return ptr;
	}
