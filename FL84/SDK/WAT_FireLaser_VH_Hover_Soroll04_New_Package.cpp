...
namespace CG
{
	...
	void UWAT_FireLaser_VH_Hover_Soroll04_New_C::K2_ActivateRealFire()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WAT_FireLaser_VH_Hover_Soroll04_New.WAT_FireLaser_VH_Hover_Soroll04_New_C.K2_ActivateRealFire");
	...
	void UWAT_FireLaser_VH_Hover_Soroll04_New_C::ExecuteUbergraph_WAT_FireLaser_VH_Hover_Soroll04_New(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WAT_FireLaser_VH_Hover_Soroll04_New.WAT_FireLaser_VH_Hover_Soroll04_New_C.ExecuteUbergraph_WAT_FireLaser_VH_Hover_Soroll04_New");
	...
	UClass* UWAT_FireLaser_VH_Hover_Soroll04_New_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass WAT_FireLaser_VH_Hover_Soroll04_New.WAT_FireLaser_VH_Hover_Soroll04_New_C");
		return ptr;
	}
