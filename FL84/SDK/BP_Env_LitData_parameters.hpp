...
{
public:
	struct FStr_EdgeLightSetting                 EdgeLightSetting;                                  // 0x0(0x30)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FStr_LightData                        CallFunc_Map_Find_Value;                           // 0x18(0x70)(IsPlainOldData, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
...
{
public:
	struct FStr_SkyLightSetting                  K2Node_MakeStruct_Str_SkyLightSetting;             // 0x0(0x8)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FStr_EdgeLightSetting                 K2Node_MakeStruct_Str_EdgeLightSetting;            // 0x8(0x30)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FStr_DirectionalLightSetting          K2Node_MakeStruct_Str_DirectionalLightSetting;     // 0x54(0x38)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FStr_LightData                        K2Node_MakeStruct_Str_LightData;                   // 0x8C(0x70)(IsPlainOldData, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
};
...
public:
	...
	struct FStr_DirectionalLightSetting          Str_DirectionalLightSetting;                       // 0x8(0x38)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FStr_SkyLightSetting                  Str_SkyLightSetting;                               // 0x8(0x8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FStr_LightData                        CallFunc_Map_Find_Value;                           // 0x4(0x70)(IsPlainOldData, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
