...
namespace CG
{
	...
	UClass* UClothConfigCommon::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ClothingSystemRuntimeCommon.ClothConfigCommon"));
		return ptr;
	}
	...
	UClass* UClothSharedConfigCommon::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ClothingSystemRuntimeCommon.ClothSharedConfigCommon"));
		return ptr;
	}
	...
	UClass* UClothingAssetCustomData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ClothingSystemRuntimeCommon.ClothingAssetCustomData"));
		return ptr;
	}
	...
	UClass* UClothingAssetCommon::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ClothingSystemRuntimeCommon.ClothingAssetCommon"));
		return ptr;
	}
	...
	UClass* UClothLODDataCommon_Legacy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ClothingSystemRuntimeCommon.ClothLODDataCommon_Legacy"));
		return ptr;
	}
