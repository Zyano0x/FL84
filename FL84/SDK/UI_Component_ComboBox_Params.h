...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function UI_Component_ComboBox.UI_Component_ComboBox_C.SetClipToBounds
	 */
	struct UUI_Component_ComboBox_C_SetClipToBounds_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_B3XT[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_T8OW[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_94EJ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
