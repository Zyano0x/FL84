...
namespace CG
{
	...
	void UBP_TabItemObj_C::OnDataRevised__DelegateSignature()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function BP_TabItemObj.BP_TabItemObj_C.OnDataRevised__DelegateSignature"));
	...
	UClass* UBP_TabItemObj_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("BlueprintGeneratedClass BP_TabItemObj.BP_TabItemObj_C"));
		return ptr;
	}
