...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RSJS[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U188[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
	};
