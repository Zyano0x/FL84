...
namespace CG
{
	...
	void UUI_Component_ReturnBtn_C::PreConstruct(bool IsDesignTime)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_ReturnBtn.UI_Component_ReturnBtn_C.PreConstruct"));
	...
	void UUI_Component_ReturnBtn_C::BndEvt__Btn_Return_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_ReturnBtn.UI_Component_ReturnBtn_C.BndEvt__Btn_Return_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	void UUI_Component_ReturnBtn_C::BndEvt__Btn_Return_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_ReturnBtn.UI_Component_ReturnBtn_C.BndEvt__Btn_Return_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature"));
	...
	void UUI_Component_ReturnBtn_C::ExecuteUbergraph_UI_Component_ReturnBtn(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_ReturnBtn.UI_Component_ReturnBtn_C.ExecuteUbergraph_UI_Component_ReturnBtn"));
	...
	void UUI_Component_ReturnBtn_C::OnPressed__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_ReturnBtn.UI_Component_ReturnBtn_C.OnPressed__DelegateSignature"));
	...
	void UUI_Component_ReturnBtn_C::OnClicked__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Component_ReturnBtn.UI_Component_ReturnBtn_C.OnClicked__DelegateSignature"));
	...
	UClass* UUI_Component_ReturnBtn_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("WidgetBlueprintGeneratedClass UI_Component_ReturnBtn.UI_Component_ReturnBtn_C"));
		return ptr;
	}
