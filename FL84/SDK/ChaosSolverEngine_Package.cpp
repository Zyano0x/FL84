...
namespace CG
{
	...
	UClass* UChaosDebugDrawComponent::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ChaosSolverEngine.ChaosDebugDrawComponent"));
		return ptr;
	}
	...
	UClass* UChaosEventListenerComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ChaosSolverEngine.ChaosEventListenerComponent"));
		return ptr;
	}
	...
	UClass* UChaosGameplayEventDispatcher::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ChaosSolverEngine.ChaosGameplayEventDispatcher"));
		return ptr;
	}
	...
	UClass* UChaosNotifyHandlerInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ChaosSolverEngine.ChaosNotifyHandlerInterface"));
		return ptr;
	}
	...
	struct FHitResult UChaosSolverEngineBlueprintLibrary::STATIC_ConvertPhysicsCollisionToHitResult(const struct FChaosPhysicsCollisionInfo& PhysicsCollision)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ChaosSolverEngine.ChaosSolverEngineBlueprintLibrary.ConvertPhysicsCollisionToHitResult"));
	...
	UClass* UChaosSolverEngineBlueprintLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ChaosSolverEngine.ChaosSolverEngineBlueprintLibrary"));
		return ptr;
	}
	...
	UClass* UChaosSolver::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ChaosSolverEngine.ChaosSolver"));
		return ptr;
	}
	...
	void AChaosSolverActor::SetSolverActive(bool bActive)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ChaosSolverEngine.ChaosSolverActor.SetSolverActive"));
	...
	void AChaosSolverActor::SetAsCurrentWorldSolver()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ChaosSolverEngine.ChaosSolverActor.SetAsCurrentWorldSolver"));
	...
	UClass* AChaosSolverActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ChaosSolverEngine.ChaosSolverActor"));
		return ptr;
	}
	...
	UClass* UChaosSolverSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ChaosSolverEngine.ChaosSolverSettings"));
		return ptr;
	}
