...
namespace CG
{
	...
	public:
		...
		class UHUD_Reload_C*                                       HUD_Reload;                                              // 0x0308(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
