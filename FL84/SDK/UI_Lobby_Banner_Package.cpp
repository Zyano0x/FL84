...
namespace CG
{
	...
	class FString UUI_Lobby_Banner_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Banner.UI_Lobby_Banner_C.GetModuleName");
	...
	UClass* UUI_Lobby_Banner_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Lobby_Banner.UI_Lobby_Banner_C");
		return ptr;
	}
