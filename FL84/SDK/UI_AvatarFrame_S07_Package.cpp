...
namespace CG
{
	...
	class FString UUI_AvatarFrame_S07_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.GetModuleName");
	...
	void UUI_AvatarFrame_S07_C::SetAvatarIcon(int32_t InAvatarID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.SetAvatarIcon");
	...
	void UUI_AvatarFrame_S07_C::SetEmptyState(bool IsEmpty)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.SetEmptyState");
	...
	void UUI_AvatarFrame_S07_C::SetPlayerGender(E_Type_Gender Gender)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.SetPlayerGender");
	...
	void UUI_AvatarFrame_S07_C::SetSocialIcon(E_Type_Social Social)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.SetSocialIcon");
	...
	void UUI_AvatarFrame_S07_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.PreConstruct");
	...
	void UUI_AvatarFrame_S07_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.Construct");
	...
	void UUI_AvatarFrame_S07_C::Update()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.Update");
	...
	void UUI_AvatarFrame_S07_C::ExecuteUbergraph_UI_AvatarFrame_S07(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.ExecuteUbergraph_UI_AvatarFrame_S07");
	...
	void UUI_AvatarFrame_S07_C::OnReleased__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.On Released__DelegateSignature");
	...
	void UUI_AvatarFrame_S07_C::OnClicked__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_AvatarFrame_S07.UI_AvatarFrame_S07_C.On Clicked__DelegateSignature");
	...
	UClass* UUI_AvatarFrame_S07_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_AvatarFrame_S07.UI_AvatarFrame_S07_C");
		return ptr;
	}
