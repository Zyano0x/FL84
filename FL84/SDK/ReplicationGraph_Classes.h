...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4C1S[0x40];                                  // 0x0058(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S3WK[0x3C0];                                 // 0x00C8(0x03C0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YDBG[0x20];                                  // 0x04D8(0x0020) Fix size for supers
	...
	public:
		...
		unsigned char                                              UnknownData_KRK2[0x8];                                   // 0x0528(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_46HW[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3GDT[0x80];                                  // 0x0050(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_4SSK[0xB8];                                  // 0x0050(0x00B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_2XY0[0x30];                                  // 0x00D0(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0RTN[0x80];                                  // 0x00D0(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_XPKP[0x10];                                  // 0x00D0(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_AFA7[0x40];                                  // 0x00D0(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_4X46[0x1D8];                                 // 0x0050(0x01D8) Fix size for supers
	...
	public:
		...
		unsigned char                                              UnknownData_3UDO[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NAUK[0x10];                                  // 0x00D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_GFQW[0x10];                                  // 0x0060(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XDDO[0x230];                                 // 0x0030(0x0230) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LFW7[0x10];                                  // 0x0268(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CJGZ[0x8];                                   // 0x0288(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0PW6[0x80];                                  // 0x02A8(0x0080) MISSED OFFSET (PADDING)
