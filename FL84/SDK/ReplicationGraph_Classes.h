...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_DLZP[0x40];                                  // 0x0058(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_M4FV[0x3C0];                                 // 0x00C8(0x03C0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YIXH[0x20];                                  // 0x04D8(0x0020) Fix size for supers
	...
	public:
		...
		unsigned char                                              UnknownData_Z28P[0x8];                                   // 0x0528(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_10SS[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_5YVW[0x80];                                  // 0x0050(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_YC5U[0xB8];                                  // 0x0050(0x00B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0EG4[0x30];                                  // 0x00D0(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_XJSU[0x78];                                  // 0x00D0(0x0078) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VIX8[0x10];                                  // 0x00D0(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_6QAO[0x40];                                  // 0x00D0(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_TE8S[0x1D8];                                 // 0x0050(0x01D8) Fix size for supers
	...
	public:
		...
		unsigned char                                              UnknownData_0YHL[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_9F3U[0x10];                                  // 0x00D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_MADK[0x10];                                  // 0x0060(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_H11H[0x1E0];                                 // 0x0030(0x01E0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6ORA[0x10];                                  // 0x0218(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4N4F[0x8];                                   // 0x0238(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_THXD[0x80];                                  // 0x0258(0x0080) MISSED OFFSET (PADDING)
