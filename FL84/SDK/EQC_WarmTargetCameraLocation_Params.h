...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function EQC_WarmTargetCameraLocation.EQC_WarmTargetCameraLocation_C.ProvideSingleLocation
	 */
	struct UEQC_WarmTargetCameraLocation_C_ProvideSingleLocation_Params
	{
	public:
