...
public:
	...
	static class AProjectile_BWL05_Primary_C* GetDefaultObj();
	...
	void ExecuteUbergraph_Projectile_BWL05_Primary(int32 EntryPoint, const struct FHitResult& K2Node_ComponentBoundEvent_ImpactResult);
};
