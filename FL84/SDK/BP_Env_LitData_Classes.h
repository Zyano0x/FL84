...
namespace CG
{
	...
	public:
		...
		struct FStr_LightData                                      LocalLightData;                                          // 0x0248(0x0070) Edit, BlueprintVisible, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_FQCN[0x7];                                   // 0x0319(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
