...
public:
	...
	struct FHitResult                            CallFunc_K2_SetActorLocation_SweepHitResult;       // 0x188(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                         CallFunc_K2_SetActorLocation_ReturnValue;          // 0x210(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
