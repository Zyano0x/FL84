...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_AvatarFrame_Pixel_SSR01.UI_AvatarFrame_Pixel_SSR01_C
	 * Size -> 0x0030 (FullSize[0x0430] - InheritedSize[0x0400])
	 */
	class UUI_AvatarFrame_Pixel_SSR01_C : public USolarUserWidget
	{
	public:
	...
	public:
		...
		void Construct();
		void Update();
		void ExecuteUbergraph_UI_AvatarFrame_Pixel_SSR01(int32_t EntryPoint);
