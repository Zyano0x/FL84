...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_5I81[0x8];                                   // 0x0228(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EW4A[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GO50[0x4];                                   // 0x0274(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_JL0U[0x8];                                   // 0x0888(0x0008) MISSED OFFSET (PADDING)
