...
public:
	...
	class UStaticMeshComponent*                  VH_Tire_Mphy01_Bullet_A;                           // 0x510(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class AProjectile_VH_Tire_Mphy01_TurretB1_Rocket_C* GetDefaultObj();
	...
	void ExecuteUbergraph_Projectile_VH_Tire_Mphy01_TurretB1_Rocket(int32 EntryPoint, const struct FHitResult& K2Node_ComponentBoundEvent_ImpactResult);
};
