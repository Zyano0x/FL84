...
namespace CG
{
	 ...
	 */
	class UBTT_GetRightLocation_C : public UBTTask_BlueprintBase
	{
	public:
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x00A8(0x0008) ZeroConstructor, Transient, DuplicateTransient
		struct FBlackboardKeySelector                              In;                                                      // 0x00B0(0x0028) Edit, BlueprintVisible
		unsigned char                                              UnknownData_SGN9[0x4];                                   // 0x00DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BTT_GetRightLocation(int32_t EntryPoint);
