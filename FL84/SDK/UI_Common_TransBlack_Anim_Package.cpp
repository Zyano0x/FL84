...
namespace CG
{
	...
	void UUI_Common_TransBlack_Anim_C::ReceiveShow()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Common_TransBlack_Anim.UI_Common_TransBlack_Anim_C.ReceiveShow");
	...
	void UUI_Common_TransBlack_Anim_C::OnEnterAnimFinished()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Common_TransBlack_Anim.UI_Common_TransBlack_Anim_C.OnEnterAnimFinished");
	...
	void UUI_Common_TransBlack_Anim_C::ExecuteUbergraph_UI_Common_TransBlack_Anim(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Common_TransBlack_Anim.UI_Common_TransBlack_Anim_C.ExecuteUbergraph_UI_Common_TransBlack_Anim");
	...
	UClass* UUI_Common_TransBlack_Anim_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Common_TransBlack_Anim.UI_Common_TransBlack_Anim_C");
		return ptr;
	}
