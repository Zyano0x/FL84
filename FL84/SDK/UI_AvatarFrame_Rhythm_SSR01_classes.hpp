...
class UUI_AvatarFrame_Rhythm_SSR01_C : public USolarUserWidget
{
public:
	...
	static class UUI_AvatarFrame_Rhythm_SSR01_C* GetDefaultObj();
	...
	void Construct();
	void Update();
	void ExecuteUbergraph_UI_AvatarFrame_Rhythm_SSR01(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool K2Node_Event_IsDesignTime);
