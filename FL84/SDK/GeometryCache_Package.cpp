...
namespace CG
{
	...
	UClass* UGeometryCache::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCache"));
		return ptr;
	}
	...
	class UGeometryCacheComponent* AGeometryCacheActor::GetGeometryCacheComponent()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheActor.GetGeometryCacheComponent"));
	...
	UClass* AGeometryCacheActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCacheActor"));
		return ptr;
	}
	...
	UClass* UGeometryCacheCodecBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCacheCodecBase"));
		return ptr;
	}
	...
	UClass* UGeometryCacheCodecRaw::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCacheCodecRaw"));
		return ptr;
	}
	...
	UClass* UGeometryCacheCodecV1::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCacheCodecV1"));
		return ptr;
	}
	...
	void UGeometryCacheComponent::TickAtThisTime(float Time, bool bInIsRunning, bool bInBackwards, bool bInIsLooping)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.TickAtThisTime"));
	...
	void UGeometryCacheComponent::Stop()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.Stop"));
	...
	void UGeometryCacheComponent::SetStartTimeOffset(float NewStartTimeOffset)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.SetStartTimeOffset"));
	...
	void UGeometryCacheComponent::SetPlaybackSpeed(float NewPlaybackSpeed)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.SetPlaybackSpeed"));
	...
	void UGeometryCacheComponent::SetLooping(bool bNewLooping)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.SetLooping"));
	...
	bool UGeometryCacheComponent::SetGeometryCache(class UGeometryCache* NewGeomCache)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.SetGeometryCache"));
	...
	void UGeometryCacheComponent::PlayReversedFromEnd()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.PlayReversedFromEnd"));
	...
	void UGeometryCacheComponent::PlayReversed()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.PlayReversed"));
	...
	void UGeometryCacheComponent::PlayFromStart()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.PlayFromStart"));
	...
	void UGeometryCacheComponent::Play()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.Play"));
	...
	void UGeometryCacheComponent::Pause()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.Pause"));
	...
	bool UGeometryCacheComponent::IsPlayingReversed()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.IsPlayingReversed"));
	...
	bool UGeometryCacheComponent::IsPlaying()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.IsPlaying"));
	...
	bool UGeometryCacheComponent::IsLooping()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.IsLooping"));
	...
	float UGeometryCacheComponent::GetStartTimeOffset()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.GetStartTimeOffset"));
	...
	float UGeometryCacheComponent::GetPlaybackSpeed()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.GetPlaybackSpeed"));
	...
	float UGeometryCacheComponent::GetPlaybackDirection()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.GetPlaybackDirection"));
	...
	int32_t UGeometryCacheComponent::GetNumberOfFrames()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.GetNumberOfFrames"));
	...
	float UGeometryCacheComponent::GetDuration()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.GetDuration"));
	...
	float UGeometryCacheComponent::GetAnimationTime()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheComponent.GetAnimationTime"));
	...
	UClass* UGeometryCacheComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCacheComponent"));
		return ptr;
	}
	...
	UClass* UGeometryCacheTrack::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCacheTrack"));
		return ptr;
	}
	...
	void UGeometryCacheTrack_FlipbookAnimation::AddMeshSample(const struct FGeometryCacheMeshData& MeshData, float SampleTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheTrack_FlipbookAnimation.AddMeshSample"));
	...
	UClass* UGeometryCacheTrack_FlipbookAnimation::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCacheTrack_FlipbookAnimation"));
		return ptr;
	}
	...
	UClass* UGeometryCacheTrackStreamable::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCacheTrackStreamable"));
		return ptr;
	}
	...
	void UGeometryCacheTrack_TransformAnimation::SetMesh(const struct FGeometryCacheMeshData& NewMeshData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheTrack_TransformAnimation.SetMesh"));
	...
	UClass* UGeometryCacheTrack_TransformAnimation::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCacheTrack_TransformAnimation"));
		return ptr;
	}
	...
	void UGeometryCacheTrack_TransformGroupAnimation::SetMesh(const struct FGeometryCacheMeshData& NewMeshData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function GeometryCache.GeometryCacheTrack_TransformGroupAnimation.SetMesh"));
	...
	UClass* UGeometryCacheTrack_TransformGroupAnimation::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class GeometryCache.GeometryCacheTrack_TransformGroupAnimation"));
		return ptr;
	}
