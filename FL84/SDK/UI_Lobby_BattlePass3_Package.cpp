...
namespace CG
{
	...
	class FString UUI_Lobby_BattlePass3_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C.GetModuleName"));
	 ...
	 * Function:
	 * 		RVA    -> 0x02D0DF90
	 * 		Name   -> Function UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C.SetStateHD
	 ...
	 */
	void UUI_Lobby_BattlePass3_C::SetStateHD(E_TabLobbyItemState State)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C.SetStateHD"));
		
		UUI_Lobby_BattlePass3_C_SetStateHD_Params params {};
		params.State = State;
	...
	void UUI_Lobby_BattlePass3_C::SetClaimable(bool NewParam)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C.SetClaimable"));
	...
	void UUI_Lobby_BattlePass3_C::SetUpdate(bool NewParam)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C.SetUpdate"));
	...
	void UUI_Lobby_BattlePass3_C::SetLevel(bool NewParam)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C.SetLevel"));
	...
	void UUI_Lobby_BattlePass3_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C.PreConstruct"));
	...
	void UUI_Lobby_BattlePass3_C::BattlePassStateChange_Event()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C.BattlePassStateChange_Event"));
	...
	void UUI_Lobby_BattlePass3_C::BattlePassPlayUpgradeAnimation()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C.BattlePassPlayUpgradeAnimation"));
	...
	void UUI_Lobby_BattlePass3_C::ExecuteUbergraph_UI_Lobby_BattlePass3(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C.ExecuteUbergraph_UI_Lobby_BattlePass3"));
	...
	UClass* UUI_Lobby_BattlePass3_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("WidgetBlueprintGeneratedClass UI_Lobby_BattlePass3.UI_Lobby_BattlePass3_C"));
		return ptr;
	}
