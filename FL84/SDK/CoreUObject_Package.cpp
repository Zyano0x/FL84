...
namespace CG
{
	...
	void UObject::ExecuteUbergraph(int32_t EntryPoint)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CoreUObject.Object.ExecuteUbergraph"));
	...
	UClass* UObject::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Object"));
		return ptr;
	}
	...
	UClass* UInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Interface"));
		return ptr;
	}
	...
	UClass* UPackage::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Package"));
		return ptr;
	}
	...
	UClass* UField::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Field"));
		return ptr;
	}
	...
	UClass* UStruct::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Struct"));
		return ptr;
	}
	...
	UClass* UClass::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Class"));
		return ptr;
	}
	...
	UClass* UGCObjectReferencer::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.GCObjectReferencer"));
		return ptr;
	}
	...
	UClass* UTextBuffer::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.TextBuffer"));
		return ptr;
	}
	...
	UClass* UScriptStruct::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.ScriptStruct"));
		return ptr;
	}
	...
	UClass* UFunction::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Function"));
		return ptr;
	}
	...
	UClass* UDelegateFunction::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.DelegateFunction"));
		return ptr;
	}
	...
	UClass* USparseDelegateFunction::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.SparseDelegateFunction"));
		return ptr;
	}
	...
	UClass* UDynamicClass::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.DynamicClass"));
		return ptr;
	}
	...
	UClass* UPackageMap::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.PackageMap"));
		return ptr;
	}
	...
	UClass* UEnum::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Enum"));
		return ptr;
	}
	...
	UClass* ULinkerPlaceholderClass::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.LinkerPlaceholderClass"));
		return ptr;
	}
	...
	UClass* ULinkerPlaceholderExportObject::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.LinkerPlaceholderExportObject"));
		return ptr;
	}
	...
	UClass* ULinkerPlaceholderFunction::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.LinkerPlaceholderFunction"));
		return ptr;
	}
	...
	UClass* UMetaData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.MetaData"));
		return ptr;
	}
	...
	UClass* UObjectRedirector::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.ObjectRedirector"));
		return ptr;
	}
	...
	UClass* UProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Property"));
		return ptr;
	}
	...
	UClass* UEnumProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.EnumProperty"));
		return ptr;
	}
	...
	UClass* UArrayProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.ArrayProperty"));
		return ptr;
	}
	...
	UClass* UObjectPropertyBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.ObjectPropertyBase"));
		return ptr;
	}
	...
	UClass* UBoolProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.BoolProperty"));
		return ptr;
	}
	...
	UClass* UNumericProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.NumericProperty"));
		return ptr;
	}
	...
	UClass* UByteProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.ByteProperty"));
		return ptr;
	}
	...
	UClass* UObjectProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.ObjectProperty"));
		return ptr;
	}
	...
	UClass* UClassProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.ClassProperty"));
		return ptr;
	}
	...
	UClass* UDelegateProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.DelegateProperty"));
		return ptr;
	}
	...
	UClass* UDoubleProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.DoubleProperty"));
		return ptr;
	}
	...
	UClass* UFloatProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.FloatProperty"));
		return ptr;
	}
	...
	UClass* UIntProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.IntProperty"));
		return ptr;
	}
	...
	UClass* UInt8Property::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Int8Property"));
		return ptr;
	}
	...
	UClass* UInt16Property::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Int16Property"));
		return ptr;
	}
	...
	UClass* UInt64Property::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.Int64Property"));
		return ptr;
	}
	...
	UClass* UInterfaceProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.InterfaceProperty"));
		return ptr;
	}
	...
	UClass* ULazyObjectProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.LazyObjectProperty"));
		return ptr;
	}
	...
	UClass* UMapProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.MapProperty"));
		return ptr;
	}
	...
	UClass* UMulticastDelegateProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.MulticastDelegateProperty"));
		return ptr;
	}
	...
	UClass* UMulticastInlineDelegateProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.MulticastInlineDelegateProperty"));
		return ptr;
	}
	...
	UClass* UMulticastSparseDelegateProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.MulticastSparseDelegateProperty"));
		return ptr;
	}
	...
	UClass* UNameProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.NameProperty"));
		return ptr;
	}
	...
	UClass* USetProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.SetProperty"));
		return ptr;
	}
	...
	UClass* USoftObjectProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.SoftObjectProperty"));
		return ptr;
	}
	...
	UClass* USoftClassProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.SoftClassProperty"));
		return ptr;
	}
	...
	UClass* UStrProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.StrProperty"));
		return ptr;
	}
	...
	UClass* UStructProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.StructProperty"));
		return ptr;
	}
	...
	UClass* UUInt16Property::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.UInt16Property"));
		return ptr;
	}
	...
	UClass* UUInt32Property::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.UInt32Property"));
		return ptr;
	}
	...
	UClass* UUInt64Property::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.UInt64Property"));
		return ptr;
	}
	...
	UClass* UWeakObjectProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.WeakObjectProperty"));
		return ptr;
	}
	...
	UClass* UTextProperty::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.TextProperty"));
		return ptr;
	}
	...
	UClass* UPropertyWrapper::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.PropertyWrapper"));
		return ptr;
	}
	...
	UClass* UMulticastDelegatePropertyWrapper::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.MulticastDelegatePropertyWrapper"));
		return ptr;
	}
	...
	UClass* UMulticastInlineDelegatePropertyWrapper::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CoreUObject.MulticastInlineDelegatePropertyWrapper"));
		return ptr;
	}
