...
namespace CG
{
	...
	void UGA_Weapon_EMP_Throw_C::K2_ActivateAbilityFromEvent(const struct FGameplayEventData& EventData)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function GA_Weapon_EMP_Throw.GA_Weapon_EMP_Throw_C.K2_ActivateAbilityFromEvent");
	...
	void UGA_Weapon_EMP_Throw_C::ExecuteUbergraph_GA_Weapon_EMP_Throw(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function GA_Weapon_EMP_Throw.GA_Weapon_EMP_Throw_C.ExecuteUbergraph_GA_Weapon_EMP_Throw");
	...
	UClass* UGA_Weapon_EMP_Throw_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass GA_Weapon_EMP_Throw.GA_Weapon_EMP_Throw_C");
		return ptr;
	}
