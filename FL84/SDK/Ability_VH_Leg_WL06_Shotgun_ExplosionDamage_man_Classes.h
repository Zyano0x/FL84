...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_JVSQ[0x8];                                   // 0x0308(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_Ability_VH_Leg_WL06_Shotgun_ExplosionDamage_man(int32_t EntryPoint);
