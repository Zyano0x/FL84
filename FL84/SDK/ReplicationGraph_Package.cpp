...
namespace CG
{
	...
	UClass* UReplicationGraph::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraph"));
		return ptr;
	}
	...
	UClass* UBasicReplicationGraph::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.BasicReplicationGraph"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode_ActorList::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode_ActorList"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode_ActorListFrequencyBuckets::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode_ActorListFrequencyBuckets"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode_DynamicSpatialFrequency::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode_DynamicSpatialFrequency"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode_ConnectionDormancyNode::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode_ConnectionDormancyNode"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode_DormancyNode::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode_DormancyNode"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode_GridCell::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode_GridCell"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode_GridSpatialization2D::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode_GridSpatialization2D"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode_AlwaysRelevant::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode_AlwaysRelevant"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode_AlwaysRelevant_ForConnection::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode_AlwaysRelevant_ForConnection"));
		return ptr;
	}
	...
	UClass* UReplicationGraphNode_TearOff_ForConnection::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphNode_TearOff_ForConnection"));
		return ptr;
	}
	...
	UClass* UNetReplicationGraphConnection::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.NetReplicationGraphConnection"));
		return ptr;
	}
	...
	void AReplicationGraphDebugActor::ServerStopDebugging()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ReplicationGraph.ReplicationGraphDebugActor.ServerStopDebugging"));
	...
	void AReplicationGraphDebugActor::ServerStartDebugging()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ReplicationGraph.ReplicationGraphDebugActor.ServerStartDebugging"));
	...
	void AReplicationGraphDebugActor::ServerSetPeriodFrameForClass(class UClass* Class, int32_t PeriodFrame)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ReplicationGraph.ReplicationGraphDebugActor.ServerSetPeriodFrameForClass"));
	...
	void AReplicationGraphDebugActor::ServerSetCullDistanceForClass(class UClass* Class, float CullDistance)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ReplicationGraph.ReplicationGraphDebugActor.ServerSetCullDistanceForClass"));
	...
	void AReplicationGraphDebugActor::ServerSetConditionalActorBreakpoint(class AActor* Actor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ReplicationGraph.ReplicationGraphDebugActor.ServerSetConditionalActorBreakpoint"));
	...
	void AReplicationGraphDebugActor::ServerPrintCullDistances()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ReplicationGraph.ReplicationGraphDebugActor.ServerPrintCullDistances"));
	...
	void AReplicationGraphDebugActor::ServerPrintAllActorInfo(const class FString& str)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ReplicationGraph.ReplicationGraphDebugActor.ServerPrintAllActorInfo"));
	...
	void AReplicationGraphDebugActor::ServerCellInfo()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ReplicationGraph.ReplicationGraphDebugActor.ServerCellInfo"));
	...
	void AReplicationGraphDebugActor::ClientCellInfo(const struct FVector& CellLocation, const struct FVector& CellExtent, TArray<class AActor*> Actors)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function ReplicationGraph.ReplicationGraphDebugActor.ClientCellInfo"));
	...
	UClass* AReplicationGraphDebugActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class ReplicationGraph.ReplicationGraphDebugActor"));
		return ptr;
	}
