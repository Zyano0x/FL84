...
public:
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x150(0xE0)(None)
	struct FLinearColor                          K2Node_Select_Default_2;                           // 0x230(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                          K2Node_Select_Default_3;                           // 0x240(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
