...
public:
	...
	static class AProjectile_Shotgun_Emphy04_Primary_C* GetDefaultObj();
	...
	void ExecuteUbergraph_Projectile_Shotgun_Emphy04_Primary(int32 EntryPoint, const struct FHitResult& K2Node_ComponentBoundEvent_ImpactResult);
};
