...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_AvatarFrame_Explore.UI_AvatarFrame_Explore_C
	 * Size -> 0x0038 (FullSize[0x0438] - InheritedSize[0x0400])
	 */
	class UUI_AvatarFrame_Explore_C : public USolarUserWidget
	{
	public:
		...
		class UParticleSystemWidget*                               Par_Snow;                                                // 0x0410(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void Construct();
		void Update();
		void ExecuteUbergraph_UI_AvatarFrame_Explore(int32_t EntryPoint);
