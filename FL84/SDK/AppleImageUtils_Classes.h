...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_B76K[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3AOK[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_F7UL[0x8];                                   // 0x0088(0x0008) MISSED OFFSET (PADDING)
