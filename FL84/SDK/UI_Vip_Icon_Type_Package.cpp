...
namespace CG
{
	...
	void UUI_Vip_Icon_Type_C::SetType(int32_t Type)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Vip_Icon_Type.UI_Vip_Icon_Type_C.SetType"));
	...
	void UUI_Vip_Icon_Type_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Vip_Icon_Type.UI_Vip_Icon_Type_C.PreConstruct"));
	...
	void UUI_Vip_Icon_Type_C::ExecuteUbergraph_UI_Vip_Icon_Type(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Vip_Icon_Type.UI_Vip_Icon_Type_C.ExecuteUbergraph_UI_Vip_Icon_Type"));
	...
	UClass* UUI_Vip_Icon_Type_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("WidgetBlueprintGeneratedClass UI_Vip_Icon_Type.UI_Vip_Icon_Type_C"));
		return ptr;
	}
