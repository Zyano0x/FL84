...
namespace SDK
{
	...
	{
	public:
		uint8                                        Pad_42[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
	};
...
#define SMALL_NUMBER 0.0f
	...
	public:
		float                                        InVal;                                             // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		uint8                                        Pad_67[0xC];                                       // Fixing Size After Last Property  [ Dumper-7 ]
		...
		uint8                                        Pad_68[0xF];                                       // Fixing Size Of Struct [ Dumper-7 ]
	};
