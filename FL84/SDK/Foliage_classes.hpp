...
public:
	...
	uint8                                        Pad_A1[0x2];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_AB[0x50];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B4[0x18];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B5[0xA0];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B6[0x78];                                      // Fixing Size Of Struct [ Dumper-7 ]
