...
{
public:
	uint8                                        Pad_96[0x50];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9F[0xA0];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A0[0x78];                                      // Fixing Size Of Struct [ Dumper-7 ]
