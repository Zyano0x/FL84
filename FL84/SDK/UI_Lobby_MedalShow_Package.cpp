...
namespace CG
{
	...
	class FString UUI_Lobby_MedalShow_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_MedalShow.UI_Lobby_MedalShow_C.GetModuleName");
	...
	UClass* UUI_Lobby_MedalShow_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Lobby_MedalShow.UI_Lobby_MedalShow_C");
		return ptr;
	}
