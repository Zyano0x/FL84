...
namespace CG
{
	...
	UClass* ACableActor::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CableComponent.CableActor"));
		return ptr;
	}
	...
	void UCableComponent::SetAttachEndToComponent(class USceneComponent* Component, const class FName& SocketName)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CableComponent.CableComponent.SetAttachEndToComponent"));
	...
	void UCableComponent::SetAttachEndTo(class AActor* Actor, const class FName& ComponentProperty, const class FName& SocketName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CableComponent.CableComponent.SetAttachEndTo"));
	...
	void UCableComponent::GetCableParticleLocations(TArray<struct FVector>* Locations)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CableComponent.CableComponent.GetCableParticleLocations"));
	...
	class USceneComponent* UCableComponent::GetAttachedComponent()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CableComponent.CableComponent.GetAttachedComponent"));
	...
	class AActor* UCableComponent::GetAttachedActor()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function CableComponent.CableComponent.GetAttachedActor"));
	...
	UClass* UCableComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class CableComponent.CableComponent"));
		return ptr;
	}
