...
class UClass* UCrosshair_CarWeapon_Cannon_2_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Crosshair_CarWeapon_Cannon_2_C");

	return Clss;
}


// Crosshair_CarWeapon_Cannon_2_C Crosshair_CarWeapon_Cannon_2.Default__Crosshair_CarWeapon_Cannon_2_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCrosshair_CarWeapon_Cannon_2_C* UCrosshair_CarWeapon_Cannon_2_C::GetDefaultObj()
{
	static class UCrosshair_CarWeapon_Cannon_2_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCrosshair_CarWeapon_Cannon_2_C*>(UCrosshair_CarWeapon_Cannon_2_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Crosshair_CarWeapon_Cannon_2.Crosshair_CarWeapon_Cannon_2_C.SetWidgetResources
...
void UCrosshair_CarWeapon_Cannon_2_C::SetWidgetResources(class UCanvasPanel** InSecondReticlePanel, class UImage** InReticleDirectionImage, class UImage** InRangedImage, class USizeBox** InAssistLockSizeBox, class UCanvasPanel** InChangeNewAssistLockPawnPanel, class UCanvasPanel** InEnterLockPawnPanel, class UCanvasPanel** InCanvas_Dynamic)
{
	...
	if (!Func)
		Func = Class->GetFunction("Crosshair_CarWeapon_Cannon_2_C", "SetWidgetResources");

	Params::UCrosshair_CarWeapon_Cannon_2_C_SetWidgetResources_Params Parms{};
