...
struct UUI_Lobby_TeamMember_Operation_C_GetModuleName_Params
{
public:
...
// 0x30 (0x30 - 0x0)
// Function UI_Lobby_TeamMember_Operation.UI_Lobby_TeamMember_Operation_C.SetHD
struct UUI_Lobby_TeamMember_Operation_C_SetHD_Params
{
public:
	bool                                         IsHD;                                              // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
// 0x6 (0x6 - 0x0)
// Function UI_Lobby_TeamMember_Operation.UI_Lobby_TeamMember_Operation_C.SetStateQuitHD
struct UUI_Lobby_TeamMember_Operation_C_SetStateQuitHD_Params
{
public:
	enum class E_Type_State_Desktop              StateQuitHD;                                       // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// 0x6 (0x6 - 0x0)
// Function UI_Lobby_TeamMember_Operation.UI_Lobby_TeamMember_Operation_C.SetStatePlayernameHD
struct UUI_Lobby_TeamMember_Operation_C_SetStatePlayernameHD_Params
{
public:
	enum class E_Type_State_Desktop              StatePlayernameHD;                                 // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class E_Type_State_Desktop              Temp_byte_Variable;                                // 0x1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable_1;                              // 0x2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable_2;                              // 0x3(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable_3;                              // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UUI_Lobby_TeamMember_Operation_C_PreConstruct_Params
{
public:
...
struct UUI_Lobby_TeamMember_Operation_C_ExecuteUbergraph_UI_Lobby_TeamMember_Operation_Params
{
public:
