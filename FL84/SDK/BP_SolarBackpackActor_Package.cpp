...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x02D656B0
	 * 		Name   -> Function BP_SolarBackpackActor.BP_SolarBackpackActor_C.LobbyForceSetLOD
	...
	void ABP_SolarBackpackActor_C::LobbyForceSetLOD()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function BP_SolarBackpackActor.BP_SolarBackpackActor_C.LobbyForceSetLOD"));
		
		ABP_SolarBackpackActor_C_LobbyForceSetLOD_Params params {};
	...
	class UMaterialInstanceDynamic* ABP_SolarBackpackActor_C::TryCreateDynamicMaterialInstance(class UPrimitiveComponent* Component, int32_t ElementIndex, class UMaterialInterface* SourceMaterial, const class FName& OptionlName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function BP_SolarBackpackActor.BP_SolarBackpackActor_C.TryCreateDynamicMaterialInstance"));
	...
	void ABP_SolarBackpackActor_C::FX_Idle()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function BP_SolarBackpackActor.BP_SolarBackpackActor_C.FX_Idle"));
	...
	void ABP_SolarBackpackActor_C::FX_Flying()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function BP_SolarBackpackActor.BP_SolarBackpackActor_C.FX_Flying"));
	...
	void ABP_SolarBackpackActor_C::FX_Charging()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function BP_SolarBackpackActor.BP_SolarBackpackActor_C.FX_Charging"));
	...
	void ABP_SolarBackpackActor_C::FX_LowPower()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function BP_SolarBackpackActor.BP_SolarBackpackActor_C.FX_LowPower"));
	...
	void ABP_SolarBackpackActor_C::FX_Default()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function BP_SolarBackpackActor.BP_SolarBackpackActor_C.FX_Default"));
	...
	UClass* ABP_SolarBackpackActor_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("BlueprintGeneratedClass BP_SolarBackpackActor.BP_SolarBackpackActor_C"));
		return ptr;
	}
