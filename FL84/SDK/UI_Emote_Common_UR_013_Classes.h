...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_Emote_Common_UR_013.UI_Emote_Common_UR_013_C
	 * Size -> 0x0030 (FullSize[0x0678] - InheritedSize[0x0648])
	 */
	class UUI_Emote_Common_UR_013_C : public UEmojiBubbleWidget
	{
	public:
	...
	public:
		...
		void Construct();
		void ExecuteUbergraph_UI_Emote_Common_UR_013(int32_t EntryPoint);
