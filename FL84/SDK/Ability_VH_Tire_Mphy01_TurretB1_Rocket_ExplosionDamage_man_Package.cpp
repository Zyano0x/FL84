...
namespace CG
{
	...
	void AAbility_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man_C::ReceiveBeginPlay()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man.Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man_C.ReceiveBeginPlay"));
	...
	void AAbility_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man_C::ReceiveTick(float DeltaSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man.Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man_C.ReceiveTick"));
	...
	void AAbility_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man_C::ExecuteUbergraph_Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man.Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man_C.ExecuteUbergraph_Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man"));
	...
	UClass* AAbility_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("BlueprintGeneratedClass Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man.Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man_C"));
		return ptr;
	}
