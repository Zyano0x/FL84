...
public:
	...
	static class UR_Weapon_Psm05_Set00_LOD0_Skeleton_AnimBlueprint_C* GetDefaultObj();

	void ExecuteUbergraph_R_Weapon_Psm05_Set00_LOD0_Skeleton_AnimBlueprint(int32 bpp__EntryPoint__pf);
