...
namespace CG
{
	 ...
	 */
	struct UCrosshair_Simple_Rifle_En_C_GetReloadWidget_Params
	{
	public:
	 ...
	 */
	struct UCrosshair_Simple_Rifle_En_C_GetAmmoWidget_Params
	{
	public:
		class UUserWidget*                                         ReturnValue;                                             // 0x0000(0x0008)  (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	 ...
	 */
	struct UCrosshair_Simple_Rifle_En_C_Update_Params
	{	};

	/**
	 * Function Crosshair_Simple_Rifle_En.Crosshair_Simple_Rifle_En_C.Construct
	 */
	struct UCrosshair_Simple_Rifle_En_C_Construct_Params
	{	};

	/**
	 * Function Crosshair_Simple_Rifle_En.Crosshair_Simple_Rifle_En_C.ExecuteUbergraph_Crosshair_Simple_Rifle_En
	 */
	struct UCrosshair_Simple_Rifle_En_C_ExecuteUbergraph_Crosshair_Simple_Rifle_En_Params
	{
	public:
