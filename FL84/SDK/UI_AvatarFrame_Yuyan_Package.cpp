...
namespace CG
{
	...
	class FString UUI_AvatarFrame_Yuyan_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.GetModuleName"));
	...
	void UUI_AvatarFrame_Yuyan_C::SetAvatarIcon(int32_t InAvatarID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.SetAvatarIcon"));
	...
	void UUI_AvatarFrame_Yuyan_C::SetEmptyState(bool IsEmpty)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.SetEmptyState"));
	...
	void UUI_AvatarFrame_Yuyan_C::SetPlayerGender(E_Type_Gender Gender)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.SetPlayerGender"));
	...
	void UUI_AvatarFrame_Yuyan_C::SetSocialIcon(E_Type_Social Social)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.SetSocialIcon"));
	...
	void UUI_AvatarFrame_Yuyan_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.PreConstruct"));
	...
	void UUI_AvatarFrame_Yuyan_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.Construct"));
	...
	void UUI_AvatarFrame_Yuyan_C::Update()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.Update"));
	...
	void UUI_AvatarFrame_Yuyan_C::ExecuteUbergraph_UI_AvatarFrame_Yuyan(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.ExecuteUbergraph_UI_AvatarFrame_Yuyan"));
	...
	void UUI_AvatarFrame_Yuyan_C::OnReleased__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.On Released__DelegateSignature"));
	...
	void UUI_AvatarFrame_Yuyan_C::OnClicked__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C.On Clicked__DelegateSignature"));
	...
	UClass* UUI_AvatarFrame_Yuyan_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("WidgetBlueprintGeneratedClass UI_AvatarFrame_Yuyan.UI_AvatarFrame_Yuyan_C"));
		return ptr;
	}
