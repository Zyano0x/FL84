...
namespace CG
{
	...
	class FString UUI_Lobby_Banner_Slot2_C::GetModuleName()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Banner_Slot2.UI_Lobby_Banner_Slot2_C.GetModuleName");
	...
	void UUI_Lobby_Banner_Slot2_C::BP_OnEntryReleased()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Banner_Slot2.UI_Lobby_Banner_Slot2_C.BP_OnEntryReleased");
	...
	void UUI_Lobby_Banner_Slot2_C::BP_OnItemExpansionChanged(bool bIsExpanded)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Banner_Slot2.UI_Lobby_Banner_Slot2_C.BP_OnItemExpansionChanged");
	...
	void UUI_Lobby_Banner_Slot2_C::BP_OnItemSelectionChanged(bool bIsSelected)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Banner_Slot2.UI_Lobby_Banner_Slot2_C.BP_OnItemSelectionChanged");
	...
	void UUI_Lobby_Banner_Slot2_C::OnListItemObjectSet(class UObject* ListItemObject)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Banner_Slot2.UI_Lobby_Banner_Slot2_C.OnListItemObjectSet");
	...
	void UUI_Lobby_Banner_Slot2_C::ChangeShowPanelView()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Banner_Slot2.UI_Lobby_Banner_Slot2_C.ChangeShowPanelView");
	...
	void UUI_Lobby_Banner_Slot2_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Banner_Slot2.UI_Lobby_Banner_Slot2_C.Construct");
	...
	void UUI_Lobby_Banner_Slot2_C::ExecuteUbergraph_UI_Lobby_Banner_Slot2(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Lobby_Banner_Slot2.UI_Lobby_Banner_Slot2_C.ExecuteUbergraph_UI_Lobby_Banner_Slot2");
	...
	UClass* UUI_Lobby_Banner_Slot2_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Lobby_Banner_Slot2.UI_Lobby_Banner_Slot2_C");
		return ptr;
	}
