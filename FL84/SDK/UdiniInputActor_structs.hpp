...
public:
	...
	uint8                                        Pad_C0D[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_C0E[0xE0];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_C1F[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_C21[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
