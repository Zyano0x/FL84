...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Crosshair_CarWeapon_Cannon_3.Crosshair_CarWeapon_Cannon_2_C.SetWidgetResources
	 */
	struct UCrosshair_CarWeapon_Cannon_2_C_SetWidgetResources_Params
	{
	public:
