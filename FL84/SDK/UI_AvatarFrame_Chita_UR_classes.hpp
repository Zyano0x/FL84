...
public:
	...
	static class UUI_AvatarFrame_Chita_UR_C* GetDefaultObj();
	...
	void Construct();
	void Update();
	void ExecuteUbergraph_UI_AvatarFrame_Chita_UR(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool K2Node_Event_IsDesignTime);
