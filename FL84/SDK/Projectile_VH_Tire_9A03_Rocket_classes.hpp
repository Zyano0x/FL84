...
public:
	...
	static class AProjectile_VH_Tire_9A03_Rocket_C* GetDefaultObj();
	...
	void ExecuteUbergraph_Projectile_VH_Tire_9A03_Rocket(int32 EntryPoint, const struct FHitResult& K2Node_ComponentBoundEvent_ImpactResult);
};
