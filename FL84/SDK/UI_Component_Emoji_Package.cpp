...
namespace CG
{
	...
	void UUI_Component_Emoji_C::PreConstruct(bool IsDesignTime)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Emoji.UI_Component_Emoji_C.PreConstruct");
	...
	void UUI_Component_Emoji_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Emoji.UI_Component_Emoji_C.Construct");
	...
	void UUI_Component_Emoji_C::ExecuteUbergraph_UI_Component_Emoji(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_Component_Emoji.UI_Component_Emoji_C.ExecuteUbergraph_UI_Component_Emoji");
	...
	UClass* UUI_Component_Emoji_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Component_Emoji.UI_Component_Emoji_C");
		return ptr;
	}
