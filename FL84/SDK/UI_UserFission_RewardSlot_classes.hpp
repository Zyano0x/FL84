...
class UUI_UserFission_RewardSlot_C : public USolarUserWidget
{
public:
	...
	static class UUI_UserFission_RewardSlot_C* GetDefaultObj();
	...
	void ExecuteUbergraph_UI_UserFission_RewardSlot(int32 EntryPoint, bool K2Node_Event_IsDesignTime);
};
