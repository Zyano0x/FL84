...
namespace CG
{
	...
	void UUI_Setting_Graphics_StyleSlot_C::PreConstruct(bool IsDesignTime)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Setting_Graphics_StyleSlot.UI_Setting_Graphics_StyleSlot_C.PreConstruct"));
	...
	void UUI_Setting_Graphics_StyleSlot_C::BndEvt__SolarCheckButton_Default_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Setting_Graphics_StyleSlot.UI_Setting_Graphics_StyleSlot_C.BndEvt__SolarCheckButton_Default_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	void UUI_Setting_Graphics_StyleSlot_C::OnSelected(bool bSelected)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Setting_Graphics_StyleSlot.UI_Setting_Graphics_StyleSlot_C.OnSelected"));
	...
	void UUI_Setting_Graphics_StyleSlot_C::ExecuteUbergraph_UI_Setting_Graphics_StyleSlot(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_Setting_Graphics_StyleSlot.UI_Setting_Graphics_StyleSlot_C.ExecuteUbergraph_UI_Setting_Graphics_StyleSlot"));
	...
	UClass* UUI_Setting_Graphics_StyleSlot_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("WidgetBlueprintGeneratedClass UI_Setting_Graphics_StyleSlot.UI_Setting_Graphics_StyleSlot_C"));
		return ptr;
	}
