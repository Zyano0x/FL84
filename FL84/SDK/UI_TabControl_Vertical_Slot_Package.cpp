...
namespace CG
{
	...
	void UUI_TabControl_Vertical_Slot_C::InitWidget(class USolarRedHint_General_C** HintWidget, class USolarTextBlock** Text, class UImage** Icon)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_TabControl_Vertical_Slot.UI_TabControl_Vertical_Slot_C.InitWidget"));
	...
	void UUI_TabControl_Vertical_Slot_C::SetStyle(E_TabStyle Style)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_TabControl_Vertical_Slot.UI_TabControl_Vertical_Slot_C.SetStyle"));
	...
	void UUI_TabControl_Vertical_Slot_C::SetSelected(bool IsSelected)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function UI_TabControl_Vertical_Slot.UI_TabControl_Vertical_Slot_C.SetSelected"));
	...
	UClass* UUI_TabControl_Vertical_Slot_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("WidgetBlueprintGeneratedClass UI_TabControl_Vertical_Slot.UI_TabControl_Vertical_Slot_C"));
		return ptr;
	}
