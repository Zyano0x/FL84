...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ZB86[0x7];                                   // 0x00B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AFO2[0x18];                                  // 0x0130(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0FBO[0xB];                                   // 0x0045(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2P3Z[0x3];                                   // 0x00B5(0x0003) Fix size for supers
	...
	public:
		...
		unsigned char                                              UnknownData_XCEM[0xF];                                   // 0x00C1(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3HBS[0x3];                                   // 0x010D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9MJ8[0xC];                                   // 0x0114(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EMMH[0x60];                                  // 0x0150(0x0060) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_QEXJ[0xC];                                   // 0x00C4(0x000C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TF2I[0x7];                                   // 0x01B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_V48W[0x8];                                   // 0x01C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_HZSY[0x4];                                   // 0x01B0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4IRO[0x17];                                  // 0x01B9(0x0017) MISSED OFFSET (PADDING)
