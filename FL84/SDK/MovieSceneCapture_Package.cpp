...
namespace CG
{
	...
	bool UMovieSceneCaptureProtocolBase::IsCapturing()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCaptureProtocolBase.IsCapturing"));
	...
	EMovieSceneCaptureProtocolState UMovieSceneCaptureProtocolBase::GetState()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCaptureProtocolBase.GetState"));
	...
	UClass* UMovieSceneCaptureProtocolBase::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.MovieSceneCaptureProtocolBase"));
		return ptr;
	}
	...
	UClass* UMovieSceneAudioCaptureProtocolBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.MovieSceneAudioCaptureProtocolBase"));
		return ptr;
	}
	...
	UClass* UNullAudioCaptureProtocol::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.NullAudioCaptureProtocol"));
		return ptr;
	}
	...
	UClass* UMasterAudioSubmixCaptureProtocol::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.MasterAudioSubmixCaptureProtocol"));
		return ptr;
	}
	...
	UClass* UMovieSceneImageCaptureProtocolBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.MovieSceneImageCaptureProtocolBase"));
		return ptr;
	}
	...
	UClass* UCompositionGraphCaptureProtocol::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.CompositionGraphCaptureProtocol"));
		return ptr;
	}
	...
	UClass* UFrameGrabberProtocol::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.FrameGrabberProtocol"));
		return ptr;
	}
	...
	UClass* UImageSequenceProtocol::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.ImageSequenceProtocol"));
		return ptr;
	}
	...
	UClass* UCompressedImageSequenceProtocol::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.CompressedImageSequenceProtocol"));
		return ptr;
	}
	...
	UClass* UImageSequenceProtocol_BMP::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.ImageSequenceProtocol_BMP"));
		return ptr;
	}
	...
	UClass* UImageSequenceProtocol_PNG::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.ImageSequenceProtocol_PNG"));
		return ptr;
	}
	...
	UClass* UImageSequenceProtocol_JPG::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.ImageSequenceProtocol_JPG"));
		return ptr;
	}
	...
	UClass* UImageSequenceProtocol_EXR::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.ImageSequenceProtocol_EXR"));
		return ptr;
	}
	...
	UClass* UMovieSceneCaptureInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.MovieSceneCaptureInterface"));
		return ptr;
	}
	...
	void UMovieSceneCapture::SetImageCaptureProtocolType(class UClass* ProtocolType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCapture.SetImageCaptureProtocolType"));
	...
	void UMovieSceneCapture::SetAudioCaptureProtocolType(class UClass* ProtocolType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCapture.SetAudioCaptureProtocolType"));
	...
	class UMovieSceneCaptureProtocolBase* UMovieSceneCapture::GetImageCaptureProtocol()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCapture.GetImageCaptureProtocol"));
	...
	class UMovieSceneCaptureProtocolBase* UMovieSceneCapture::GetAudioCaptureProtocol()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCapture.GetAudioCaptureProtocol"));
	...
	UClass* UMovieSceneCapture::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.MovieSceneCapture"));
		return ptr;
	}
	...
	UClass* ULevelCapture::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.LevelCapture"));
		return ptr;
	}
	...
	bool UMovieSceneCaptureEnvironment::STATIC_IsCaptureInProgress()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCaptureEnvironment.IsCaptureInProgress"));
	...
	int32_t UMovieSceneCaptureEnvironment::STATIC_GetCaptureFrameNumber()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCaptureEnvironment.GetCaptureFrameNumber"));
	...
	float UMovieSceneCaptureEnvironment::STATIC_GetCaptureElapsedTime()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCaptureEnvironment.GetCaptureElapsedTime"));
	...
	class UMovieSceneImageCaptureProtocolBase* UMovieSceneCaptureEnvironment::STATIC_FindImageCaptureProtocol()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCaptureEnvironment.FindImageCaptureProtocol"));
	...
	class UMovieSceneAudioCaptureProtocolBase* UMovieSceneCaptureEnvironment::STATIC_FindAudioCaptureProtocol()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.MovieSceneCaptureEnvironment.FindAudioCaptureProtocol"));
	...
	UClass* UMovieSceneCaptureEnvironment::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.MovieSceneCaptureEnvironment"));
		return ptr;
	}
	...
	void UUserDefinedCaptureProtocol::StopCapturingFinalPixels()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.StopCapturingFinalPixels"));
	...
	void UUserDefinedCaptureProtocol::StartCapturingFinalPixels(const struct FCapturedPixelsID& StreamID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.StartCapturingFinalPixels"));
	...
	void UUserDefinedCaptureProtocol::ResolveBuffer(class UTexture* Buffer, const struct FCapturedPixelsID& BufferID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.ResolveBuffer"));
	...
	void UUserDefinedCaptureProtocol::OnWarmUp()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnWarmUp"));
	...
	void UUserDefinedCaptureProtocol::OnTick()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnTick"));
	...
	void UUserDefinedCaptureProtocol::OnStartCapture()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnStartCapture"));
	...
	bool UUserDefinedCaptureProtocol::OnSetup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnSetup"));
	...
	void UUserDefinedCaptureProtocol::OnPreTick()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnPreTick"));
	...
	void UUserDefinedCaptureProtocol::OnPixelsReceived(const struct FCapturedPixels& Pixels, const struct FCapturedPixelsID& ID, const struct FFrameMetrics& FrameMetrics)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnPixelsReceived"));
	...
	void UUserDefinedCaptureProtocol::OnPauseCapture()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnPauseCapture"));
	...
	void UUserDefinedCaptureProtocol::OnFinalize()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnFinalize"));
	...
	void UUserDefinedCaptureProtocol::OnCaptureFrame()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnCaptureFrame"));
	...
	bool UUserDefinedCaptureProtocol::OnCanFinalize()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnCanFinalize"));
	...
	void UUserDefinedCaptureProtocol::OnBeginFinalize()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.OnBeginFinalize"));
	...
	struct FFrameMetrics UUserDefinedCaptureProtocol::GetCurrentFrameMetrics()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.GetCurrentFrameMetrics"));
	...
	class FString UUserDefinedCaptureProtocol::GenerateFilename(const struct FFrameMetrics& InFrameMetrics)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedCaptureProtocol.GenerateFilename"));
	...
	UClass* UUserDefinedCaptureProtocol::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.UserDefinedCaptureProtocol"));
		return ptr;
	}
	...
	void UUserDefinedImageCaptureProtocol::WriteImageToDisk(const struct FCapturedPixels& PixelData, const struct FCapturedPixelsID& StreamID, const struct FFrameMetrics& FrameMetrics, bool bCopyImageData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedImageCaptureProtocol.WriteImageToDisk"));
	...
	class FString UUserDefinedImageCaptureProtocol::GenerateFilenameForCurrentFrame()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedImageCaptureProtocol.GenerateFilenameForCurrentFrame"));
	...
	class FString UUserDefinedImageCaptureProtocol::GenerateFilenameForBuffer(class UTexture* Buffer, const struct FCapturedPixelsID& StreamID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(xorstr_("Function MovieSceneCapture.UserDefinedImageCaptureProtocol.GenerateFilenameForBuffer"));
	...
	UClass* UUserDefinedImageCaptureProtocol::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.UserDefinedImageCaptureProtocol"));
		return ptr;
	}
	...
	UClass* UVideoCaptureProtocol::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(xorstr_("Class MovieSceneCapture.VideoCaptureProtocol"));
		return ptr;
	}
