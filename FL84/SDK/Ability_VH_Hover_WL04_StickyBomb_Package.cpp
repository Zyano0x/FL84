...
namespace CG
{
	...
	void AAbility_VH_Hover_WL04_StickyBomb_C::ReceiveBeginPlay()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Ability_VH_Hover_WL04_StickyBomb.Ability_VH_Hover_WL04_StickyBomb_C.ReceiveBeginPlay");
	...
	void AAbility_VH_Hover_WL04_StickyBomb_C::ReceiveTick(float DeltaSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Ability_VH_Hover_WL04_StickyBomb.Ability_VH_Hover_WL04_StickyBomb_C.ReceiveTick");
	...
	void AAbility_VH_Hover_WL04_StickyBomb_C::ExecuteUbergraph_Ability_VH_Hover_WL04_StickyBomb(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Ability_VH_Hover_WL04_StickyBomb.Ability_VH_Hover_WL04_StickyBomb_C.ExecuteUbergraph_Ability_VH_Hover_WL04_StickyBomb");
	...
	UClass* AAbility_VH_Hover_WL04_StickyBomb_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass Ability_VH_Hover_WL04_StickyBomb.Ability_VH_Hover_WL04_StickyBomb_C");
		return ptr;
	}
