...
namespace CG
{
	...
	void UUI_TabControl_Vertical_C::SetBindWidget(class UListView** BindList)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_TabControl_Vertical.UI_TabControl_Vertical_C.SetBindWidget");
	...
	void UUI_TabControl_Vertical_C::SetStyle()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_TabControl_Vertical.UI_TabControl_Vertical_C.SetStyle");
	...
	void UUI_TabControl_Vertical_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_TabControl_Vertical.UI_TabControl_Vertical_C.PreConstruct");
	...
	void UUI_TabControl_Vertical_C::ExecuteUbergraph_UI_TabControl_Vertical(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function UI_TabControl_Vertical.UI_TabControl_Vertical_C.ExecuteUbergraph_UI_TabControl_Vertical");
	...
	UClass* UUI_TabControl_Vertical_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_TabControl_Vertical.UI_TabControl_Vertical_C");
		return ptr;
	}
