...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * DelegateFunction UI_ChatPanel.UI_ChatPanel_C.OnClicked_99D13E6F43EDD0FD240D55A6D328D5C1
	 */
	struct UUI_ChatPanel_C_OnClicked_99D13E6F43EDD0FD240D55A6D328D5C1_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_C7J1[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
