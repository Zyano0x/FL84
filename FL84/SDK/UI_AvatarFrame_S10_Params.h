...
namespace CG
{
	 ...
	 */
	struct UUI_AvatarFrame_S10_C_Construct_Params
	{	};

	/**
	 * Function UI_AvatarFrame_S10.UI_AvatarFrame_S10_C.Update
	 */
	struct UUI_AvatarFrame_S10_C_Update_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_G1N5[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function UI_AvatarFrame_S10.UI_AvatarFrame_S10_C.On Released__DelegateSignature
	 */
	struct UUI_AvatarFrame_S10_C_OnReleased__DelegateSignature_Params
	{	};

	/**
	 * Function UI_AvatarFrame_S10.UI_AvatarFrame_S10_C.On Clicked__DelegateSignature
	 */
	struct UUI_AvatarFrame_S10_C_OnClicked__DelegateSignature_Params
	{	};
