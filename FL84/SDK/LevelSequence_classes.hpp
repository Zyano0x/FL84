...
{
public:
	uint8                                        Pad_BF3[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_A1 : 5;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_BFF[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C21[0x108];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C2E[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
