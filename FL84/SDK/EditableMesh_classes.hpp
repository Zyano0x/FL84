...
public:
	...
	uint8                                        Pad_74F[0x9C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_860[0x390];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_863[0x148];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_865[0x1E4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_876[0xA4];                                     // Fixing Size Of Struct [ Dumper-7 ]
