...
namespace CG
{
	...
	public:
		...
		struct FSlateBrush                                         KeyBrush;                                                // 0x0018(0x0098) Edit, NativeAccessSpecifierPublic
	};
	...
	public:
		...
		struct FSlateBrush                                         KeyBrush;                                                // 0x0010(0x0098) Edit, NativeAccessSpecifierPublic
	};
	...
	{
	public:
		unsigned char                                              UnknownData_OZOS[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PHEE[0x2];                                   // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
